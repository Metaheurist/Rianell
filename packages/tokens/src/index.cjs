...
/* @rianell/loader-tokens — mirror packages/tokens/src/index.mjs */
const TEAM_TOKENS = {
  mint: {
    dark: {
      color: { accent: '#7bdf8c', background: '#070807', text: '#e8eeec' },
      loader: {
        primary: '#7bdf8c',
        bright: '#d6ffdd',
        mid: '#9ae8a4',
  ...
  'red-black': {
    dark: {
      color: { accent: '#ff4d5a', background: '#070807', text: '#e8eeec' },
      loader: {
        primary: '#ff4d5a',
        bright: '#ffd7dc',
        mid: '#ff8d98',
  ...
  mono: {
    dark: {
      color: { accent: '#f2f2f2', background: '#070807', text: '#e8eeec' },
      loader: {
        primary: '#f1f1f1',
        bright: '#ffffff',
        mid: '#d0d0d0',
  ...
  rainbow: {
    dark: {
      color: { accent: '#ff4fa0', background: '#070807', text: '#e8eeec' },
      loader: {
        primary: '#ff4fa0',
        bright: '#ffe0f2',
        mid: '#ffd54f',
...
function applyColorblindOverride(tokens, colorblindMode) {
  ...
  if (colorblindMode === 'deuteranopia' || colorblindMode === 'protanopia') {
    ...
    if (out.loader) {
      out.loader.primary = '#4d75ff';
      out.loader.mid = '#7c9cff';
      out.loader.deep = '#3949ab';
    }
  } else if (colorblindMode === 'tritanopia') {
    out.color.accent = '#ff4fa0';
    if (out.loader) {
      out.loader.primary = '#ff4fa0';
      out.loader.mid = '#ff8db3';
      out.loader.deep = '#c2185b';
    }
    ...
    if (out.loader) {
      out.loader.primary = '#ffffff';
      out.loader.bright = '#ffffff';
      out.loader.mid = '#cccccc';
      out.loader.deep = '#888888';
      out.loader.shellBg = '#000000';
      out.loader.shellTop = '#000000';
      out.loader.shellMid = '#000000';
      out.loader.shellBot = '#000000';
      out.loader.loadingText = 'rgba(255, 255, 255, 0.95)';
    }
  }
  return out;
}
