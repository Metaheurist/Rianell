...
export const THEME_FX_TOKENS = {
  ...
  teams: {
    mint: {
      particleType: 'leaves',
      particleColor: '#7bdf8c',
      particleColorAlt: '#a8e6cf',
      subtleCount: 8,
      boldCount: 18,
      glow: '#7bdf8c',
    },
    'red-black': {
      particleType: 'embers',
      particleColor: '#ff8d98',
      particleColorAlt: '#ff4d5a',
      subtleCount: 10,
      boldCount: 22,
      glow: '#ff8d98',
    },
    mono: {
      particleType: 'smoke',
      particleColor: 'rgba(208,208,208,0.35)',
      particleColorAlt: 'rgba(120,120,120,0.25)',
      subtleCount: 6,
      boldCount: 14,
      glow: '#d0d0d0',
    },
    rainbow: {
      particleType: 'rain',
      particleColor: '#ff4fa0',
      particleColorAlt: '#7bdf8c',
      subtleCount: 12,
      boldCount: 28,
      glow: '#ff4fa0',
      prism: ['#ff4fa0', '#ff9800', '#ffeb3b', '#7bdf8c', '#2196f3', '#9c27b0'],
    },
  },
};
// ─── END THEME FX TOKENS ───────────────────────────────────────────────────
