...
**Related:** [incident-response.md](../incident-response.md) · [SECURITY.md](../SECURITY.md)
...
- In-app and published privacy disclosures must match actual data practices.
...
- [ ] Confirm privacy policy URL live on the deployed site
