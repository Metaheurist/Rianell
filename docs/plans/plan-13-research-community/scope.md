...
- Features listed in [plan.md](./plan.md) and [../MASTER.md(../MASTER.md) §12
- Legal review before RE1 production copy.
...
| Command | When |
|---------|------|
| `node docs/plans/plan-13-research-community/scripts/verify-plan.mjs` | Before local gate |
