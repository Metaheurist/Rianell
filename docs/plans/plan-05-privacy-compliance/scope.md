...
- Features listed in [plan.md](./plan.md) and [../MASTER.md(../MASTER.md) §7
- Pairs S7 consent dashboard. P4 enables CL2.
...
| Command | When |
|---------|------|
| `node docs/plans/plan-05-privacy-compliance/scripts/verify-plan.mjs` | Before local gate |
