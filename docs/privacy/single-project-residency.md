...
1. One Supabase URL + anon key in PWA `supabase-config.js`.
...
- **Disclaimer:** `policy.machineTranslatedNotice` is shown in the PWA policy viewer for non-en-GB locales; **en-GB** text and linked policy pack remain authoritative.
