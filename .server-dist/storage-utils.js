...
async function compressData(data) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("storage-utils.js", "compressData", arguments) : undefined;
  try {
    try {
      if (hasCompressionStream) {
        ...
        chunks.forEach(chunk => {
          var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("storage-utils.js", "[arrow]", undefined) : undefined;
          try {
...
async function decompressData(compressedData) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("storage-utils.js", "decompressData", arguments) : undefined;
  try {
    try {
      if (hasCompressionStream && compressedData.startsWith('H4sI')) {
        ...
        const decompressed = chunks.map(chunk => decoder.decode(chunk, {
          stream: true
        })).join('');
...
function isCompressed(data) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("storage-utils.js", "isCompressed", arguments) : undefined;
  try {
...
const CompressedStorage = {
  async setItem(key, value) {
    var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("storage-utils.js", "setItem", arguments) : undefined;
    try {
      try {
  ...
  async getItem(key) {
    var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("storage-utils.js", "getItem", arguments) : undefined;
    try {
      try {
  ...
  removeItem(key) {
    var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("storage-utils.js", "removeItem", arguments) : undefined;
    try {
...
async function migrateToCompressedStorage() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("storage-utils.js", "migrateToCompressedStorage", arguments) : undefined;
  try {
    try {
      const appSettings = JSON.parse(localStorage.getItem('rianellSettings') || '{}');
