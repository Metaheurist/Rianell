...
const CLOUD_SYNC_EXTRA_SETTING_KEYS = ['rianellFunctionTrace', 'rianellEnableStaticSW', 'rianellTutorialSeen', 'rianellInstallModalAfterTutorialSeen', 'installPromptDismissed'];

// Initialize Supabase client
let supabaseClient = null;
function isSupabaseConfigPlaceholder() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "isSupabaseConfigPlaceholder", arguments) : undefined;
  try {
    try {
...
function initSupabase() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "initSupabase", arguments) : undefined;
  try {
    if (supabaseClient) {
...
async function syncAnonymizedData() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "syncAnonymizedData", arguments) : undefined;
  try {
    ...
    try {
      ...
      try {
        ...
        while (hasMore) {
          const {
            data,
            error
          } = await supabaseClient.from('anonymized_data').select('anonymized_log').eq('medical_condition', medicalCondition).range(from, from + pageSize - 1);
          if (error) {
      ...
      const logsToSync = logs.filter(log => {
        var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "[arrow]", undefined) : undefined;
        try {
        ...
        for (const log of batch) {
          try {
            ...
            const anonymizedLog = {
              ...
              food: function () {
                var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "anonymous", arguments) : undefined;
                try {
        ...
        if (batchData.length > 0) {
          try {
            const {
              data,
              error
            } = await supabaseClient.from('anonymized_data').insert(batchData).select();
            if (error) {
              // Use safe error logging to prevent information leakage
              if (window.SecurityUtils && window.SecurityUtils.safeLogError) {
              ...
              const isDuplicateError = errorMessage.includes('duplicate') || errorMessage.includes('unique') || errorMessage.includes('violates unique constraint') || error.code === '23505'; // PostgreSQL unique violation code
...
async function logSyncToServer(recordsCount, condition) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "logSyncToServer", arguments) : undefined;
  try {
    try {
      const response = await fetch('/api/sync-log', {
        ...
        body: JSON.stringify({
          ...
          synced_count: recordsCount,
          // Also send as synced_count for compatibility
          condition: condition,
...
function setupBackgroundSync() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "setupBackgroundSync", arguments) : undefined;
  try {
...
function toggleAutoSync() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "toggleAutoSync", arguments) : undefined;
  try {
...
async function checkConditionDataAvailability(condition) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "checkConditionDataAvailability", arguments) : undefined;
  try {
    try {
      ...
      while (hasMore) {
        const {
          ...
          error,
          count
        } = await supabaseClient.from('anonymized_data').select('id, anonymized_log', {
          count: 'exact'
        }).eq('medical_condition', condition).range(from, from + pageSize - 1);
        if (error) {
...
function loadCloudSyncState() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "loadCloudSyncState", arguments) : undefined;
  try {
    try {
...
function saveCloudSyncState() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "saveCloudSyncState", arguments) : undefined;
  try {
    try {
...
function collectExtraLocalSettings() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "collectExtraLocalSettings", arguments) : undefined;
  try {
    const extras = {};
...
function applyExtraLocalSettings(extras) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "applyExtraLocalSettings", arguments) : undefined;
  try {
...
function updateCloudSyncUI() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "updateCloudSyncUI", arguments) : undefined;
  try {
...
async function checkAuthStatus() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "checkAuthStatus", arguments) : undefined;
  try {
...
async function handleCloudSignUp(context) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "handleCloudSignUp", arguments) : undefined;
  try {
    ...
    try {
      ...
      if (data.user) {
        ...
        if (typeof showAlertModal === 'function') {
          showAlertModal('Account created successfully! Please check your email to verify your account. You can sign in after verification.', 'Account Created');
        } else {
...
async function handleCloudLogin(context) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "handleCloudLogin", arguments) : undefined;
  try {
    const emailId = context && context.emailId || 'cloudEmail';
    const passwordId = context && context.passwordId || 'cloudPassword';
    ...
    try {
      ...
      if (data.user) {
        ...
        if (!data.user.email_confirmed_at) {
          if (typeof showAlertModal === 'function') {
            showAlertModal('Please verify your email address before signing in. Check your inbox for the verification email.', 'Email Verification Required');
          } else {
...
async function handleCloudLogout() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "handleCloudLogout", arguments) : undefined;
  try {
    const client = initSupabase();
    if (!client) {
      console.error('Supabase client not available');
...
async function getUserEncryptionKey() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "getUserEncryptionKey", arguments) : undefined;
  try {
    try {
      const client = initSupabase();
      ...
      const {
        data: keyData,
        error: keyError
      } = await client.from('user_keys').select('encryption_key').eq('user_id', cloudSyncState.user.id).single();
      ...
      if (insertError) {
        ...
        const {
          ...
          error: refetchErr
        } = await client.from('user_keys').select('encryption_key').eq('user_id', cloudSyncState.user.id).maybeSingle();
...
function generateUserEncryptionKey() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "generateUserEncryptionKey", arguments) : undefined;
  try {
...
async function encryptWithUserKey(data, userKey) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "encryptWithUserKey", arguments) : undefined;
  try {
    if (!userKey) {
...
async function decryptWithUserKey(encryptedData, userKey) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "decryptWithUserKey", arguments) : undefined;
  try {
...
async function syncToCloud() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "syncToCloud", arguments) : undefined;
  try {
    if (!cloudSyncState.isAuthenticated || !cloudSyncState.user) {
      if (typeof showAlertModal === 'function') {
    ...
    try {
      ...
      const {
        data: cloudData,
        error: fetchError
      } = await client.from('health_data').select('health_logs, app_settings, ai_state').eq('user_id', cloudSyncState.user.id).single();
      let cloudLogs = [];
      let cloudSettings = {};
      ...
      const cloudExtraSettings = cloudSettings && typeof cloudSettings.__extraLocalSettings === 'object' ? cloudSettings.__extraLocalSettings : {};
      const localExtraSettings = collectExtraLocalSettings();
      mergedSettings.__extraLocalSettings = {
        ...cloudExtraSettings,
        ...localExtraSettings
      };
      ...
      const {
        error: upsertError
      } = await client.from('health_data').upsert(upsertPayload, {
        onConflict: 'user_id',
      ...
      updateCloudSyncUI();
      if (typeof showAlertModal === 'function') {
        showAlertModal(`Successfully synced ${mergedLogs.length} health log(s). Cloud and local data are now in sync.`, 'Sync Complete');
      } else {
...
function mergeHealthLogs(localLogs, cloudLogs) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "mergeHealthLogs", arguments) : undefined;
  try {
...
async function syncDeletedLogToCloud(deletedDate) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "syncDeletedLogToCloud", arguments) : undefined;
  try {
    if (!cloudSyncState.isAuthenticated || !cloudSyncState.user) {
    ...
    try {
      ...
      const {
        data: cloudData,
        error: fetchError
      } = await client.from('health_data').select('health_logs, app_settings').eq('user_id', cloudSyncState.user.id).single();
      if (!cloudData) {
      ...
      const {
        error: updateError
      } = await client.from('health_data').update({
        health_logs: encryptedLogs,
        updated_at: new Date().toISOString()
...
async function loadFromCloud() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "loadFromCloud", arguments) : undefined;
  try {
    if (!cloudSyncState.isAuthenticated || !cloudSyncState.user) {
...
async function getAnonymizedTrainingData(medicalCondition) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "getAnonymizedTrainingData", arguments) : undefined;
  try {
    try {
...
async function deleteCloudLogs() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "deleteCloudLogs", arguments) : undefined;
  try {
    try {
      const client = initSupabase();
      if (!client || !cloudSyncState.user) {
      ...
      const {
        error: deleteHealthError
      } = await client.from('health_data').delete().eq('user_id', userId);
...
async function deleteAllUserDataFromCloud() {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "deleteAllUserDataFromCloud", arguments) : undefined;
  try {
    try {
      const client = initSupabase();
      if (!client || !cloudSyncState.user) {
      ...
      deleteOperations.push(client.from('health_data').delete().eq('user_id', userId).then(result => {
        var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "[arrow]", undefined) : undefined;
        try {
          if (result.error) {
      ...
      deleteOperations.push(client.from('user_keys').delete().eq('user_id', userId).then(result => {
        var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "[arrow]", undefined) : undefined;
        try {
          if (result.error) {
...
if (typeof window !== 'undefined') {
  ...
  function setupSupabaseAuthListener() {
    var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "setupSupabaseAuthListener", arguments) : undefined;
    try {
  ...
  function runCloudAuthAfterSupabaseConfig() {
    var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "runCloudAuthAfterSupabaseConfig", arguments) : undefined;
    try {
  ...
  function scheduleCloudAuthInit() {
    var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "scheduleCloudAuthInit", arguments) : undefined;
    try {
...
function clearSyncedKeys(condition = null) {
  var __rt = typeof __rianellTraceEnter === "function" ? __rianellTraceEnter("cloud-sync.js", "clearSyncedKeys", arguments) : undefined;
  try {
    if (condition) {
      const syncedKeysJson = localStorage.getItem('anonymizedDataSyncedKeys');
      if (syncedKeysJson) {
