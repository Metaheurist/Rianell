 ...
 * Usage: node scripts/ci/generate-security-inventory.mjs [--check]
 */
import fs from 'fs';
...
if (process.argv.includes('--check')) {
  ...
  if (existing !== content) {
    console.error('security-inventory: docs/security-inventory.md is out of date. Run: node scripts/ci/generate-security-inventory.mjs');
    process.exit(1);
  }
