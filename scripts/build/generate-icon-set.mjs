 ...
 *
 * Usage:
 *   node scripts/build/generate-icon-set.mjs --source "C:/path/to/source.png"
 *
 * Outputs:
...
async function main() {
  ...
  if (!sourcePath) {
    throw new Error('Missing --source argument. Example: node scripts/build/generate-icon-set.mjs --source "C:/image.png"');
  }
