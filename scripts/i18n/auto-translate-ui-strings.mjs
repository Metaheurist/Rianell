 ...
 * Usage:
 *   node scripts/i18n/auto-translate-ui-strings.mjs [--dry-run]
 *   node scripts/i18n/auto-translate-ui-strings.mjs --translate   # MT when DEEPL_AUTH_KEY / GOOGLE_TRANSLATE_API_KEY set
 */
