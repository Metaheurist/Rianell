 ...
 *
 * Usage:
 *   USE_MYMEMORY_MT=1 node scripts/i18n/batch-mt-tier-a.mjs [--locale=pt-BR] [--dry-run]
 */
...
console.log('batch-mt-tier-a: run node scripts/i18n/generate-locale-overrides.mjs && node scripts/i18n/sync-i18n-assets.mjs');
