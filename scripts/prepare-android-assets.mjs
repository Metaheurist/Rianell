 ...
 * Sources: web/Icons/logo-source.png (preferred), else web/Icons/Icon-512.png (upscale),
...
async function main() {
  ...
  await sharp({
    ...
    .toFile(outFile);
  console.warn(
    'prepare-android-assets: no web/Icons/logo-source.png or Icon-512.png; wrote flat placeholder logo.png — add logo-source.png for branded APK icons.'
  );
}
