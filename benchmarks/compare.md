...
Generated at **2026-06-19T18:38:40.112Z**.
...
xychart-beta
    ...
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0"]
    y-axis "ms" 0 --> 16491
    line [14406, 14991, 13053, 14092, 13942, 13945, 13945, 14014, 13997, 13868]
```
```mermaid
xychart-beta
    ...
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0"]
    y-axis "ms" 0 --> 195
    line [169, 135, 153, 147, 148, 146, 159, 177, 148, 150]
```
...
xychart-beta
    ...
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0"]
    y-axis "ms" 0 --> 15667
    line [13355, 13197, 14098, 14242, 12895, 14078, 12749, 13943, 12738, 12578]
```
```mermaid
xychart-beta
    ...
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0"]
    y-axis "ms" 0 --> 182
    line [152, 124, 156, 165, 149, 132, 146, 144, 134, 124]
```
...
xychart-beta
    ...
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0"]
    y-axis "bytes" 0 --> 3875896
    line [3523541, 3511474, 3496393, 3494445, 3491111, 3478911, 3474606, 3468338, 3454266, 3434635]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0"]
    y-axis "bytes" 0 --> 3867448
    line [3515861, 3502937, 3488256, 3486228, 3483393, 3471867, 3466755, 3460455, 3446796, 3426562]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1"]
    y-axis "ms" 0 --> 16491
    line [14406, 14991, 13053, 14092, 13942]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1"]
    y-axis "ms" 0 --> 15667
    line [13355, 13197, 14098, 14242, 12895]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1"]
    y-axis "bytes" 0 --> 3875896
    line [3523541, 3511474, 3496393, 3494445, 3491111]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1"]
    y-axis "bytes" 0 --> 3867448
    line [3515861, 3502937, 3488256, 3486228, 3483393]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410"]
    y-axis "ms" 0 --> 16491
    line [14406, 14991, 13053, 14092, 13942, 13945, 13945, 14014, 13997, 13868, 12854, 12437, 12430, 12295, 13197, 13323, 13038, 12168, 11999, 12553]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410"]
    y-axis "ms" 0 --> 219
    line [169, 135, 153, 147, 148, 146, 159, 177, 148, 150, 64, 116, 131, 136, 154, 127, 120, 199, 132, 65]
```
...
xychart-beta
    ...
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410"]
    y-axis "ms" 0 --> 15667
    line [13355, 13197, 14098, 14242, 12895, 14078, 12749, 13943, 12738, 12578, 13605, 12438, 12126, 12180, 12127, 13036, 11979, 11847, 11759, 12402]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410"]
    y-axis "ms" 0 --> 182
    line [152, 124, 156, 165, 149, 132, 146, 144, 134, 124, 72, 122, 129, 130, 118, 122, 115, 110, 120, 71]
```
...
xychart-beta
    ...
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410"]
    y-axis "bytes" 0 --> 3875896
    line [3523541, 3511474, 3496393, 3494445, 3491111, 3478911, 3474606, 3468338, 3454266, 3434635, 3421569, 3417622, 3400545, 3388765, 3375300, 3368860, 3368861, 3349208, 3324082, 3305549]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410"]
    y-axis "bytes" 0 --> 3867448
    line [3515861, 3502937, 3488256, 3486228, 3483393, 3471867, 3466755, 3460455, 3446796, 3426562, 3414256, 3409221, 3391123, 3378280, 3368083, 3360774, 3360776, 3341646, 3316545, 3297734]
```
