...
Generated at **2026-03-29T19:51:09.104Z**.
...
xychart-beta
    ...
    x-axis ["37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 12895
    line [11698, 11566, 11571, 11711, 11699, 11703, 11722, 11697]
```
```mermaid
xychart-beta
...
xychart-beta
    ...
    x-axis ["37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 12890
    line [11710, 11560, 11561, 11705, 11718, 11715, 11701, 11707]
```
```mermaid
xychart-beta
...
xychart-beta
    ...
    x-axis ["37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 9722
    line [8731, 8688, 8693, 8834, 8838, 8835, 8833, 8830]
```
```mermaid
xychart-beta
...
xychart-beta
    ...
    line [2356472, 2356474, 2356472, 2356301, 2356304, 2356302, 2356302, 2356299]
```
```mermaid
xychart-beta
    ...
    line [2350043, 2350046, 2350041, 2349868, 2349864, 2349868, 2349869, 2349865]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e"]
    y-axis "ms" 0 --> 12883
    line [11698, 11566, 11571, 11711, 11699]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e"]
    y-axis "ms" 0 --> 12890
    line [11710, 11560, 11561, 11705, 11718]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e"]
    y-axis "bytes" 0 --> 2592122
    line [2356472, 2356474, 2356472, 2356301, 2356304]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e"]
    y-axis "bytes" 0 --> 2585051
    line [2350043, 2350046, 2350041, 2349868, 2349864]
```
