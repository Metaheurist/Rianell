...
Generated at **2026-06-20T10:01:11.083Z**.
...
xychart-beta
    ...
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1"]
    y-axis "ms" 0 --> 16491
    line [13962, 13654, 13664, 13678, 13670, 14406, 14991, 13053, 14092, 13942]
```
```mermaid
xychart-beta
    ...
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1"]
    y-axis "ms" 0 --> 186
    line [155, 151, 142, 139, 136, 169, 135, 153, 147, 148]
```
...
xychart-beta
    ...
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1"]
    y-axis "ms" 0 --> 16183
    line [13660, 13653, 14556, 13636, 14711, 13355, 13197, 14098, 14242, 12895]
```
```mermaid
xychart-beta
    ...
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1"]
    y-axis "ms" 0 --> 182
    line [156, 157, 149, 146, 164, 152, 124, 156, 165, 149]
```
...
xychart-beta
    ...
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1"]
    y-axis "bytes" 0 --> 4147698
    line [3770634, 3767812, 3557908, 3544463, 3543472, 3523541, 3511474, 3496393, 3494445, 3491111]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1"]
    y-axis "bytes" 0 --> 4139007
    line [3762733, 3759872, 3548602, 3534279, 3535273, 3515861, 3502937, 3488256, 3486228, 3483393]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "ms" 0 --> 15359
    line [13962, 13654, 13664, 13678, 13670]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "ms" 0 --> 16183
    line [13660, 13653, 14556, 13636, 14711]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "bytes" 0 --> 4147698
    line [3770634, 3767812, 3557908, 3544463, 3543472]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "bytes" 0 --> 4139007
    line [3762733, 3759872, 3548602, 3534279, 3535273]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0"]
    y-axis "ms" 0 --> 16491
    line [13962, 13654, 13664, 13678, 13670, 14406, 14991, 13053, 14092, 13942, 13945, 13945, 14014, 13997, 13868, 12854, 12437, 12430, 12295, 13197]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0"]
    y-axis "ms" 0 --> 195
    line [155, 151, 142, 139, 136, 169, 135, 153, 147, 148, 146, 159, 177, 148, 150, 64, 116, 131, 136, 154]
```
...
xychart-beta
    ...
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0"]
    y-axis "ms" 0 --> 16183
    line [13660, 13653, 14556, 13636, 14711, 13355, 13197, 14098, 14242, 12895, 14078, 12749, 13943, 12738, 12578, 13605, 12438, 12126, 12180, 12127]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0"]
    y-axis "ms" 0 --> 182
    line [156, 157, 149, 146, 164, 152, 124, 156, 165, 149, 132, 146, 144, 134, 124, 72, 122, 129, 130, 118]
```
...
xychart-beta
    ...
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0"]
    y-axis "bytes" 0 --> 4147698
    line [3770634, 3767812, 3557908, 3544463, 3543472, 3523541, 3511474, 3496393, 3494445, 3491111, 3478911, 3474606, 3468338, 3454266, 3434635, 3421569, 3417622, 3400545, 3388765, 3375300]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0"]
    y-axis "bytes" 0 --> 4139007
    line [3762733, 3759872, 3548602, 3534279, 3535273, 3515861, 3502937, 3488256, 3486228, 3483393, 3471867, 3466755, 3460455, 3446796, 3426562, 3414256, 3409221, 3391123, 3378280, 3368083]
```
