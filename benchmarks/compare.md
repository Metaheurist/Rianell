...
Generated at **2026-03-29T21:00:58.077Z**.
...
xychart-beta
    ...
    x-axis ["a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 12895
    line [11716, 11698, 11566, 11571, 11711, 11699, 11703, 11722, 11697]
```
```mermaid
xychart-beta
    ...
    x-axis ["a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 76
    line [62, 46, 63, 53, 60, 68, 69, 68, 68]
```
...
xychart-beta
    ...
    x-axis ["a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 12890
    line [11707, 11710, 11560, 11561, 11705, 11718, 11715, 11701, 11707]
```
```mermaid
xychart-beta
    ...
    x-axis ["a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 69
    line [54, 58, 56, 57, 52, 62, 61, 60, 54]
```
...
xychart-beta
    ...
    x-axis ["a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 9722
    line [8837, 8731, 8688, 8693, 8834, 8838, 8835, 8833, 8830]
```
```mermaid
xychart-beta
    ...
    x-axis ["a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 59
    line [45, 53, 34, 26, 38, 34, 31, 32, 27]
```
...
xychart-beta
    ...
    x-axis ["a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "bytes" 0 --> 2592354
    line [2356685, 2356472, 2356474, 2356472, 2356301, 2356304, 2356302, 2356302, 2356299]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "bytes" 0 --> 2585193
    line [2350175, 2350043, 2350046, 2350041, 2349868, 2349864, 2349868, 2349869, 2349865]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0"]
    y-axis "ms" 0 --> 12888
    line [11716, 11698, 11566, 11571, 11711]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0"]
    y-axis "ms" 0 --> 12882
    line [11707, 11710, 11560, 11561, 11705]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0"]
    y-axis "bytes" 0 --> 2592354
    line [2356685, 2356472, 2356474, 2356472, 2356301]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0"]
    y-axis "bytes" 0 --> 2585193
    line [2350175, 2350043, 2350046, 2350041, 2349868]
```
