...
Generated at **2026-06-20T10:27:26.837Z**.
...
xychart-beta
    ...
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d"]
    y-axis "ms" 0 --> 16491
    line [13971, 13962, 13654, 13664, 13678, 13670, 14406, 14991, 13053, 14092]
```
```mermaid
xychart-beta
    ...
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d"]
    y-axis "ms" 0 --> 186
    line [155, 155, 151, 142, 139, 136, 169, 135, 153, 147]
```
...
xychart-beta
    ...
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d"]
    y-axis "ms" 0 --> 16183
    line [13811, 13660, 13653, 14556, 13636, 14711, 13355, 13197, 14098, 14242]
```
```mermaid
xychart-beta
    ...
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d"]
    y-axis "ms" 0 --> 182
    line [163, 156, 157, 149, 146, 164, 152, 124, 156, 165]
```
...
xychart-beta
    ...
    line [3771343, 3770634, 3767812, 3557908, 3544463, 3543472, 3523541, 3511474, 3496393, 3494445]
```
```mermaid
xychart-beta
    ...
    line [3762498, 3762733, 3759872, 3548602, 3534279, 3535273, 3515861, 3502937, 3488256, 3486228]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7"]
    y-axis "ms" 0 --> 15369
    line [13971, 13962, 13654, 13664, 13678]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7"]
    y-axis "ms" 0 --> 16012
    line [13811, 13660, 13653, 14556, 13636]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7"]
    y-axis "bytes" 0 --> 4148478
    line [3771343, 3770634, 3767812, 3557908, 3544463]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7"]
    y-axis "bytes" 0 --> 4139007
    line [3762498, 3762733, 3759872, 3548602, 3534279]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2"]
    y-axis "ms" 0 --> 16491
    line [13971, 13962, 13654, 13664, 13678, 13670, 14406, 14991, 13053, 14092, 13942, 13945, 13945, 14014, 13997, 13868, 12854, 12437, 12430, 12295]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2"]
    y-axis "ms" 0 --> 195
    line [155, 155, 151, 142, 139, 136, 169, 135, 153, 147, 148, 146, 159, 177, 148, 150, 64, 116, 131, 136]
```
...
xychart-beta
    ...
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2"]
    y-axis "ms" 0 --> 16183
    line [13811, 13660, 13653, 14556, 13636, 14711, 13355, 13197, 14098, 14242, 12895, 14078, 12749, 13943, 12738, 12578, 13605, 12438, 12126, 12180]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2"]
    y-axis "ms" 0 --> 182
    line [163, 156, 157, 149, 146, 164, 152, 124, 156, 165, 149, 132, 146, 144, 134, 124, 72, 122, 129, 130]
```
...
xychart-beta
    ...
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2"]
    y-axis "bytes" 0 --> 4148478
    line [3771343, 3770634, 3767812, 3557908, 3544463, 3543472, 3523541, 3511474, 3496393, 3494445, 3491111, 3478911, 3474606, 3468338, 3454266, 3434635, 3421569, 3417622, 3400545, 3388765]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2"]
    y-axis "bytes" 0 --> 4139007
    line [3762498, 3762733, 3759872, 3548602, 3534279, 3535273, 3515861, 3502937, 3488256, 3486228, 3483393, 3471867, 3466755, 3460455, 3446796, 3426562, 3414256, 3409221, 3391123, 3378280]
```
