...
Generated at **2026-06-19T16:35:35.841Z**.
...
xychart-beta
    ...
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2"]
    y-axis "ms" 0 --> 15416
    line [13942, 13945, 13945, 14014, 13997, 13868, 12854, 12437, 12430, 12295]
```
```mermaid
xychart-beta
    ...
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2"]
    y-axis "ms" 0 --> 195
    line [148, 146, 159, 177, 148, 150, 64, 116, 131, 136]
```
...
xychart-beta
    ...
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2"]
    y-axis "ms" 0 --> 15486
    line [12895, 14078, 12749, 13943, 12738, 12578, 13605, 12438, 12126, 12180]
```
```mermaid
xychart-beta
    ...
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2"]
    y-axis "ms" 0 --> 164
    line [149, 132, 146, 144, 134, 124, 72, 122, 129, 130]
```
...
xychart-beta
    ...
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2"]
    y-axis "bytes" 0 --> 3840223
    line [3491111, 3478911, 3474606, 3468338, 3454266, 3434635, 3421569, 3417622, 3400545, 3388765]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2"]
    y-axis "bytes" 0 --> 3831733
    line [3483393, 3471867, 3466755, 3460455, 3446796, 3426562, 3414256, 3409221, 3391123, 3378280]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad"]
    y-axis "ms" 0 --> 15416
    line [13942, 13945, 13945, 14014, 13997]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad"]
    y-axis "ms" 0 --> 15486
    line [12895, 14078, 12749, 13943, 12738]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad"]
    y-axis "bytes" 0 --> 3840223
    line [3491111, 3478911, 3474606, 3468338, 3454266]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad"]
    y-axis "bytes" 0 --> 3831733
    line [3483393, 3471867, 3466755, 3460455, 3446796]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381"]
    y-axis "ms" 0 --> 15416
    line [13942, 13945, 13945, 14014, 13997, 13868, 12854, 12437, 12430, 12295, 13197, 13323, 13038, 12168, 11999, 12553, 11687, 13245, 12382, 12632]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381"]
    y-axis "ms" 0 --> 219
    line [148, 146, 159, 177, 148, 150, 64, 116, 131, 136, 154, 127, 120, 199, 132, 65, 111, 118, 138, 118]
```
...
xychart-beta
    ...
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381"]
    y-axis "ms" 0 --> 15486
    line [12895, 14078, 12749, 13943, 12738, 12578, 13605, 12438, 12126, 12180, 12127, 13036, 11979, 11847, 11759, 12402, 12580, 12444, 11529, 12751]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381"]
    y-axis "ms" 0 --> 164
    line [149, 132, 146, 144, 134, 124, 72, 122, 129, 130, 118, 122, 115, 110, 120, 71, 109, 126, 112, 141]
```
...
xychart-beta
    ...
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381"]
    y-axis "bytes" 0 --> 3840223
    line [3491111, 3478911, 3474606, 3468338, 3454266, 3434635, 3421569, 3417622, 3400545, 3388765, 3375300, 3368860, 3368861, 3349208, 3324082, 3305549, 3300038, 3300034, 3300038, 3300630]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381"]
    y-axis "bytes" 0 --> 3831733
    line [3483393, 3471867, 3466755, 3460455, 3446796, 3426562, 3414256, 3409221, 3391123, 3378280, 3368083, 3360774, 3360776, 3341646, 3316545, 3297734, 3293199, 3293198, 3293200, 3293409]
```
