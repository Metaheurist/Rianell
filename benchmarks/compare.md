...
Generated at **2026-06-14T08:26:29.688Z**.
...
xychart-beta
    ...
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3"]
    y-axis "ms" 0 --> 14920
    line [13531, 13563, 13394, 12124, 12007, 12072, 11911, 11695, 11707, 11844]
```
```mermaid
xychart-beta
    ...
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3"]
    y-axis "ms" 0 --> 174
    line [97, 140, 158, 20, 54, 110, 55, 38, 48, 41]
```
...
xychart-beta
    ...
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3"]
    y-axis "ms" 0 --> 14874
    line [13521, 13383, 13388, 12127, 12028, 11904, 11863, 11768, 11742, 11838]
```
```mermaid
xychart-beta
    ...
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3"]
    y-axis "ms" 0 --> 104
    line [65, 94, 87, 39, 77, 53, 46, 47, 40, 39]
```
...
xychart-beta
    ...
    line [3239886, 3240548, 2511667, 2411913, 2377489, 2377488, 2370632, 2370632, 2370634, 2362082]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3"]
    y-axis "bytes" 0 --> 3553954
    line [3230867, 3230712, 2504401, 2405024, 2370491, 2370493, 2363429, 2363431, 2363430, 2356086]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12"]
    y-axis "ms" 0 --> 14920
    line [13531, 13563, 13394, 12124, 12007]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12"]
    y-axis "ms" 0 --> 14874
    line [13521, 13383, 13388, 12127, 12028]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12"]
    y-axis "bytes" 0 --> 3564603
    line [3239886, 3240548, 2511667, 2411913, 2377489]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12"]
    y-axis "bytes" 0 --> 3553954
    line [3230867, 3230712, 2504401, 2405024, 2370491]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3"]
    y-axis "ms" 0 --> 14920
    line [13531, 13563, 13394, 12124, 12007, 12072, 11911, 11695, 11707, 11844, 11862, 11845, 11860, 11572, 11701, 11691, 11716, 11698, 11566, 11571]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3"]
    y-axis "ms" 0 --> 174
    line [97, 140, 158, 20, 54, 110, 55, 38, 48, 41, 58, 47, 57, 68, 47, 39, 62, 46, 63, 53]
```
...
xychart-beta
    ...
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3"]
    y-axis "ms" 0 --> 14874
    line [13521, 13383, 13388, 12127, 12028, 11904, 11863, 11768, 11742, 11838, 11855, 11852, 11847, 11548, 11710, 11718, 11707, 11710, 11560, 11561]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3"]
    y-axis "ms" 0 --> 104
    line [65, 94, 87, 39, 77, 53, 46, 47, 40, 39, 52, 48, 58, 44, 54, 65, 54, 58, 56, 57]
```
...
xychart-beta
    ...
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3"]
    y-axis "bytes" 0 --> 3564603
    line [3239886, 3240548, 2511667, 2411913, 2377489, 2377488, 2370632, 2370632, 2370634, 2362082, 2362084, 2362047, 2362047, 2362048, 2362047, 2356686, 2356685, 2356472, 2356474, 2356472]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3"]
    y-axis "bytes" 0 --> 3553954
    line [3230867, 3230712, 2504401, 2405024, 2370491, 2370493, 2363429, 2363431, 2363430, 2356086, 2356086, 2356058, 2356058, 2356060, 2356059, 2350178, 2350175, 2350043, 2350046, 2350041]
```
