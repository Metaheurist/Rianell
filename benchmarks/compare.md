...
Generated at **2026-06-26T19:45:11.271Z**.
...
xychart-beta
    ...
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429"]
    y-axis "ms" 0 --> 22418
    line [20346, 20361, 20380, 19099, 19257, 19097, 19090, 19227, 19255, 19076]
```
```mermaid
xychart-beta
    ...
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429"]
    y-axis "ms" 0 --> 704
    line [351, 328, 340, 266, 279, 271, 292, 640, 311, 235]
```
...
xychart-beta
    ...
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429"]
    y-axis "ms" 0 --> 22447
    line [20406, 20374, 20366, 19133, 19145, 19077, 19086, 19101, 19086, 19199]
```
```mermaid
xychart-beta
    ...
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429"]
    y-axis "ms" 0 --> 392
    line [350, 334, 356, 281, 283, 259, 277, 276, 275, 240]
```
...
xychart-beta
    ...
    line [3979178, 3979178, 3979178, 3858192, 3858192, 3858195, 3858763, 3858763, 3858762, 3858764]
```
```mermaid
xychart-beta
    ...
    line [3971946, 3971945, 3971946, 3849365, 3849367, 3849366, 3850104, 3850105, 3850105, 3850104]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e"]
    y-axis "ms" 0 --> 22418
    line [20346, 20361, 20380, 19099, 19257]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e"]
    y-axis "ms" 0 --> 22447
    line [20406, 20374, 20366, 19133, 19145]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e"]
    y-axis "bytes" 0 --> 4377096
    line [3979178, 3979178, 3979178, 3858192, 3858192]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e"]
    y-axis "bytes" 0 --> 4369141
    line [3971946, 3971945, 3971946, 3849365, 3849367]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643"]
    y-axis "ms" 0 --> 22418
    line [20346, 20361, 20380, 19099, 19257, 19097, 19090, 19227, 19255, 19076, 18898, 18874, 18888, 18728, 18722, 18436, 18270, 18278, 18267, 18242]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643"]
    y-axis "ms" 0 --> 704
    line [351, 328, 340, 266, 279, 271, 292, 640, 311, 235, 237, 243, 207, 241, 336, 225, 210, 218, 207, 182]
```
...
xychart-beta
    ...
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643"]
    y-axis "ms" 0 --> 22447
    line [20406, 20374, 20366, 19133, 19145, 19077, 19086, 19101, 19086, 19199, 18871, 18888, 18892, 18741, 18704, 18438, 18287, 18290, 18265, 18222]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643"]
    y-axis "ms" 0 --> 392
    line [350, 334, 356, 281, 283, 259, 277, 276, 275, 240, 216, 215, 224, 236, 229, 227, 221, 230, 221, 159]
```
...
xychart-beta
    ...
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643"]
    y-axis "bytes" 0 --> 4377096
    line [3979178, 3979178, 3979178, 3858192, 3858192, 3858195, 3858763, 3858763, 3858762, 3858764, 3845905, 3843474, 3841087, 3837618, 3836645, 3819535, 3807947, 3807947, 3802529, 3802528]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643"]
    y-axis "bytes" 0 --> 4369141
    line [3971946, 3971945, 3971946, 3849365, 3849367, 3849366, 3850104, 3850105, 3850105, 3850104, 3837764, 3833771, 3832292, 3830296, 3828818, 3810818, 3801309, 3801305, 3796002, 3796002]
```
