...
Generated at **2026-06-30T00:08:25.217Z**.
...
xychart-beta
    ...
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19"]
    y-axis "ms" 0 --> 24593
    line [21095, 19101, 19549, 19542, 18663, 19248, 22351, 22326, 22357, 22240]
```
```mermaid
xychart-beta
    ...
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19"]
    y-axis "ms" 0 --> 545
    line [411, 348, 402, 443, 333, 395, 399, 436, 479, 495]
```
...
xychart-beta
    ...
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19"]
    y-axis "ms" 0 --> 24631
    line [0, 18641, 18940, 18936, 18660, 18674, 22391, 22250, 22344, 22178]
```
```mermaid
xychart-beta
    ...
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19"]
    y-axis "ms" 0 --> 547
    line [0, 385, 342, 353, 352, 362, 396, 377, 497, 391]
```
...
xychart-beta
    ...
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19"]
    y-axis "bytes" 0 --> 4483141
    line [4075582, 4052821, 4052813, 4049448, 4046554, 4048091, 4030638, 4030634, 4030639, 4025609]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19"]
    y-axis "bytes" 0 --> 4472399
    line [4065817, 4047233, 4047234, 4042958, 4039809, 4039179, 4023650, 4023650, 4023645, 4024761]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141"]
    y-axis "ms" 0 --> 23205
    line [21095, 19101, 19549, 19542, 18663]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141"]
    y-axis "ms" 0 --> 20834
    line [0, 18641, 18940, 18936, 18660]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141"]
    y-axis "bytes" 0 --> 4483141
    line [4075582, 4052821, 4052813, 4049448, 4046554]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141"]
    y-axis "bytes" 0 --> 4472399
    line [4065817, 4047233, 4047234, 4042958, 4039809]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1"]
    y-axis "ms" 0 --> 24593
    line [21095, 19101, 19549, 19542, 18663, 19248, 22351, 22326, 22357, 22240, 22209, 21878, 21870, 21566, 21132, 20925, 20504, 20549, 20346, 20361]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1"]
    y-axis "ms" 0 --> 735
    line [411, 348, 402, 443, 333, 395, 399, 436, 479, 495, 507, 475, 500, 372, 526, 362, 353, 668, 351, 328]
```
...
xychart-beta
    ...
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1"]
    y-axis "ms" 0 --> 24631
    line [0, 18641, 18940, 18936, 18660, 18674, 22391, 22250, 22344, 22178, 22170, 21853, 21828, 21442, 21100, 20773, 20501, 20513, 20406, 20374]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1"]
    y-axis "ms" 0 --> 547
    line [0, 385, 342, 353, 352, 362, 396, 377, 497, 391, 363, 343, 359, 369, 319, 359, 328, 369, 350, 334]
```
...
xychart-beta
    ...
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1"]
    y-axis "bytes" 0 --> 4483141
    line [4075582, 4052821, 4052813, 4049448, 4046554, 4048091, 4030638, 4030634, 4030639, 4025609, 4026084, 4023969, 4020690, 4016661, 4010565, 3997221, 3982594, 3982590, 3979178, 3979178]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1"]
    y-axis "bytes" 0 --> 4472399
    line [4065817, 4047233, 4047234, 4042958, 4039809, 4039179, 4023650, 4023650, 4023645, 4024761, 4017281, 4017565, 4012063, 4008470, 4002116, 3990384, 3978033, 3978036, 3971946, 3971945]
```
