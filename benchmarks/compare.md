...
Generated at **2026-06-15T21:59:08.913Z**.
...
xychart-beta
    ...
    x-axis ["1d3b3ff", "97c29c1", "4c6144b", "f167b31", "afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa"]
    y-axis "ms" 0 --> 15504
    line [13484, 14084, 14094, 13501, 13531, 13563, 13394, 12124, 12007, 12072]
```
```mermaid
xychart-beta
    ...
    x-axis ["1d3b3ff", "97c29c1", "4c6144b", "f167b31", "afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa"]
    y-axis "ms" 0 --> 184
    line [90, 135, 167, 121, 97, 140, 158, 20, 54, 110]
```
...
xychart-beta
    ...
    x-axis ["1d3b3ff", "97c29c1", "4c6144b", "f167b31", "afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa"]
    y-axis "ms" 0 --> 15497
    line [13177, 14085, 14088, 13032, 13521, 13383, 13388, 12127, 12028, 11904]
```
```mermaid
xychart-beta
    ...
    x-axis ["1d3b3ff", "97c29c1", "4c6144b", "f167b31", "afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa"]
    y-axis "ms" 0 --> 158
    line [98, 117, 143, 92, 65, 94, 87, 39, 77, 53]
```
...
xychart-beta
    ...
    x-axis ["1d3b3ff", "97c29c1", "00011b8", "4c6144b", "f167b31", "afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12"]
    y-axis "bytes" 0 --> 3616167
    line [3287424, 3266092, 3266094, 3266092, 3266093, 3239886, 3240548, 2511667, 2411913, 2377489]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["1d3b3ff", "97c29c1", "00011b8", "4c6144b", "f167b31", "afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12"]
    y-axis "bytes" 0 --> 3606018
    line [3278198, 3258272, 3258276, 3258273, 3258270, 3230867, 3230712, 2504401, 2405024, 2370491]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["1d3b3ff", "97c29c1", "4c6144b", "f167b31", "afb25d4"]
    y-axis "ms" 0 --> 15504
    line [13484, 14084, 14094, 13501, 13531]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["1d3b3ff", "97c29c1", "4c6144b", "f167b31", "afb25d4"]
    y-axis "ms" 0 --> 15497
    line [13177, 14085, 14088, 13032, 13521]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    title "Expo — Android Hermes gzip total (bytes)"
    x-axis ["1d3b3ff", "97c29c1", "00011b8", "4c6144b", "f167b31"]
    y-axis "bytes" 0 --> 3616167
    line [3287424, 3266092, 3266094, 3266092, 3266093]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["1d3b3ff", "97c29c1", "00011b8", "4c6144b", "f167b31"]
    y-axis "bytes" 0 --> 3606018
    line [3278198, 3258272, 3258276, 3258273, 3258270]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["1d3b3ff", "97c29c1", "4c6144b", "f167b31", "afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465"]
    y-axis "ms" 0 --> 15504
    line [13484, 14084, 14094, 13501, 13531, 13563, 13394, 12124, 12007, 12072, 11911, 11695, 11707, 11844, 11862, 11845, 11860, 11572, 11701, 11691]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["1d3b3ff", "97c29c1", "4c6144b", "f167b31", "afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465"]
    y-axis "ms" 0 --> 184
    line [90, 135, 167, 121, 97, 140, 158, 20, 54, 110, 55, 38, 48, 41, 58, 47, 57, 68, 47, 39]
```
...
xychart-beta
    ...
    x-axis ["1d3b3ff", "97c29c1", "4c6144b", "f167b31", "afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465"]
    y-axis "ms" 0 --> 15497
    line [13177, 14085, 14088, 13032, 13521, 13383, 13388, 12127, 12028, 11904, 11863, 11768, 11742, 11838, 11855, 11852, 11847, 11548, 11710, 11718]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["1d3b3ff", "97c29c1", "4c6144b", "f167b31", "afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465"]
    y-axis "ms" 0 --> 158
    line [98, 117, 143, 92, 65, 94, 87, 39, 77, 53, 46, 47, 40, 39, 52, 48, 58, 44, 54, 65]
```
...
xychart-beta
    title "Expo — Android Hermes gzip total (bytes)"
    x-axis ["1d3b3ff", "97c29c1", "00011b8", "4c6144b", "f167b31", "afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd"]
    y-axis "bytes" 0 --> 3616167
    line [3287424, 3266092, 3266094, 3266092, 3266093, 3239886, 3240548, 2511667, 2411913, 2377489, 2377488, 2370632, 2370632, 2370634, 2362082, 2362084, 2362047, 2362047, 2362048, 2362047]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["1d3b3ff", "97c29c1", "00011b8", "4c6144b", "f167b31", "afb25d4", "36e0b4b", "5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd"]
    y-axis "bytes" 0 --> 3606018
    line [3278198, 3258272, 3258276, 3258273, 3258270, 3230867, 3230712, 2504401, 2405024, 2370491, 2370493, 2363429, 2363431, 2363430, 2356086, 2356086, 2356058, 2356058, 2356060, 2356059]
```
