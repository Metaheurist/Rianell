...
Generated at **2026-06-27T01:21:33.801Z**.
...
xychart-beta
    ...
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190"]
    y-axis "ms" 0 --> 23018
    line [20925, 20504, 20549, 20346, 20361, 20380, 19099, 19257, 19097, 19090]
```
```mermaid
xychart-beta
    ...
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190"]
    y-axis "ms" 0 --> 735
    line [362, 353, 668, 351, 328, 340, 266, 279, 271, 292]
```
...
xychart-beta
    ...
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190"]
    y-axis "ms" 0 --> 22851
    line [20773, 20501, 20513, 20406, 20374, 20366, 19133, 19145, 19077, 19086]
```
```mermaid
xychart-beta
    ...
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190"]
    y-axis "ms" 0 --> 406
    line [359, 328, 369, 350, 334, 356, 281, 283, 259, 277]
```
...
xychart-beta
    ...
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190"]
    y-axis "bytes" 0 --> 4396944
    line [3997221, 3982594, 3982590, 3979178, 3979178, 3979178, 3858192, 3858192, 3858195, 3858763]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190"]
    y-axis "bytes" 0 --> 4389423
    line [3990384, 3978033, 3978036, 3971946, 3971945, 3971946, 3849365, 3849367, 3849366, 3850104]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1"]
    y-axis "ms" 0 --> 23018
    line [20925, 20504, 20549, 20346, 20361]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1"]
    y-axis "ms" 0 --> 22851
    line [20773, 20501, 20513, 20406, 20374]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1"]
    y-axis "bytes" 0 --> 4396944
    line [3997221, 3982594, 3982590, 3979178, 3979178]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1"]
    y-axis "bytes" 0 --> 4389423
    line [3990384, 3978033, 3978036, 3971946, 3971945]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26"]
    y-axis "ms" 0 --> 23018
    line [20925, 20504, 20549, 20346, 20361, 20380, 19099, 19257, 19097, 19090, 19227, 19255, 19076, 18898, 18874, 18888, 18728, 18722, 18436, 18270]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26"]
    y-axis "ms" 0 --> 735
    line [362, 353, 668, 351, 328, 340, 266, 279, 271, 292, 640, 311, 235, 237, 243, 207, 241, 336, 225, 210]
```
...
xychart-beta
    ...
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26"]
    y-axis "ms" 0 --> 22851
    line [20773, 20501, 20513, 20406, 20374, 20366, 19133, 19145, 19077, 19086, 19101, 19086, 19199, 18871, 18888, 18892, 18741, 18704, 18438, 18287]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26"]
    y-axis "ms" 0 --> 406
    line [359, 328, 369, 350, 334, 356, 281, 283, 259, 277, 276, 275, 240, 216, 215, 224, 236, 229, 227, 221]
```
...
xychart-beta
    ...
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26"]
    y-axis "bytes" 0 --> 4396944
    line [3997221, 3982594, 3982590, 3979178, 3979178, 3979178, 3858192, 3858192, 3858195, 3858763, 3858763, 3858762, 3858764, 3845905, 3843474, 3841087, 3837618, 3836645, 3819535, 3807947]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26"]
    y-axis "bytes" 0 --> 4389423
    line [3990384, 3978033, 3978036, 3971946, 3971945, 3971946, 3849365, 3849367, 3849366, 3850104, 3850105, 3850105, 3850104, 3837764, 3833771, 3832292, 3830296, 3828818, 3810818, 3801309]
```
