...
Generated at **2026-06-24T00:13:24.529Z**.
...
xychart-beta
    ...
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1"]
    y-axis "ms" 0 --> 21181
    line [19097, 19090, 19227, 19255, 19076, 18898, 18874, 18888, 18728, 18722]
```
```mermaid
xychart-beta
    ...
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1"]
    y-axis "ms" 0 --> 704
    line [271, 292, 640, 311, 235, 237, 243, 207, 241, 336]
```
...
xychart-beta
    ...
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1"]
    y-axis "ms" 0 --> 21119
    line [19077, 19086, 19101, 19086, 19199, 18871, 18888, 18892, 18741, 18704]
```
```mermaid
xychart-beta
    ...
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1"]
    y-axis "ms" 0 --> 305
    line [259, 277, 276, 275, 240, 216, 215, 224, 236, 229]
```
...
xychart-beta
    ...
    line [3858195, 3858763, 3858763, 3858762, 3858764, 3845905, 3843474, 3841087, 3837618, 3836645]
```
```mermaid
xychart-beta
    ...
    line [3849366, 3850104, 3850105, 3850105, 3850104, 3837764, 3833771, 3832292, 3830296, 3828818]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429"]
    y-axis "ms" 0 --> 21181
    line [19097, 19090, 19227, 19255, 19076]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429"]
    y-axis "ms" 0 --> 21119
    line [19077, 19086, 19101, 19086, 19199]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429"]
    y-axis "bytes" 0 --> 4244641
    line [3858195, 3858763, 3858763, 3858762, 3858764]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429"]
    y-axis "bytes" 0 --> 4235116
    line [3849366, 3850104, 3850105, 3850105, 3850104]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510"]
    y-axis "ms" 0 --> 21181
    line [19097, 19090, 19227, 19255, 19076, 18898, 18874, 18888, 18728, 18722, 18436, 18270, 18278, 18267, 18242, 18254, 14947, 14588, 14818, 13807]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510"]
    y-axis "ms" 0 --> 704
    line [271, 292, 640, 311, 235, 237, 243, 207, 241, 336, 225, 210, 218, 207, 182, 163, 59, 132, 117, 160]
```
...
xychart-beta
    ...
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510"]
    y-axis "ms" 0 --> 21119
    line [19077, 19086, 19101, 19086, 19199, 18871, 18888, 18892, 18741, 18704, 18438, 18287, 18290, 18265, 18222, 18275, 14936, 14957, 13769, 13952]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510"]
    y-axis "ms" 0 --> 305
    line [259, 277, 276, 275, 240, 216, 215, 224, 236, 229, 227, 221, 230, 221, 159, 209, 61, 106, 121, 168]
```
...
xychart-beta
    ...
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510"]
    y-axis "bytes" 0 --> 4244641
    line [3858195, 3858763, 3858763, 3858762, 3858764, 3845905, 3843474, 3841087, 3837618, 3836645, 3819535, 3807947, 3807947, 3802529, 3802528, 3802527, 3796378, 3791714, 3791716, 3770636]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["b15d2db", "09a1190", "51e147b", "4db54b3", "2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510"]
    y-axis "bytes" 0 --> 4235116
    line [3849366, 3850104, 3850105, 3850105, 3850104, 3837764, 3833771, 3832292, 3830296, 3828818, 3810818, 3801309, 3801305, 3796002, 3796002, 3796005, 3788525, 3783517, 3783520, 3762734]
```
