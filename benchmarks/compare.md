...
Generated at **2026-06-17T20:03:47.307Z**.
...
xychart-beta
    ...
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226"]
    y-axis "ms" 0 --> 15905
    line [12420, 14457, 14459, 13617, 14386, 14419, 13497, 13828, 13339, 14256]
```
```mermaid
xychart-beta
    ...
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226"]
    y-axis "ms" 0 --> 178
    line [110, 161, 142, 88, 135, 159, 160, 153, 131, 151]
```
...
xychart-beta
    ...
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226"]
    y-axis "ms" 0 --> 16051
    line [12421, 13612, 14591, 14540, 13488, 14410, 14392, 14255, 14254, 13354]
```
```mermaid
xychart-beta
    ...
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226"]
    y-axis "ms" 0 --> 182
    line [106, 158, 145, 107, 135, 165, 137, 129, 155, 154]
```
...
xychart-beta
    ...
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226"]
    y-axis "bytes" 0 --> 3626296
    line [3296025, 3296632, 3296023, 3295973, 3295761, 3295758, 3295757, 3291461, 3291455, 3291464]
```
```mermaid
xychart-beta
    ...
    line [3288856, 3288399, 3288861, 3288877, 3288270, 3288272, 3288270, 3283767, 3283770, 3283769]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68"]
    y-axis "ms" 0 --> 15905
    line [12420, 14457, 14459, 13617, 14386]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68"]
    y-axis "ms" 0 --> 16051
    line [12421, 13612, 14591, 14540, 13488]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68"]
    y-axis "bytes" 0 --> 3626296
    line [3296025, 3296632, 3296023, 3295973, 3295761]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68"]
    y-axis "bytes" 0 --> 3617765
    line [3288856, 3288399, 3288861, 3288877, 3288270]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228", "f1d81b5", "f02224d", "cb092d9", "9c3f148", "910fc5a"]
    y-axis "ms" 0 --> 15905
    line [12420, 14457, 14459, 13617, 14386, 14419, 13497, 13828, 13339, 14256, 13811, 13665, 12311, 13514, 14099, 14091, 13178, 14089, 13157, 14103]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228", "f1d81b5", "f02224d", "cb092d9", "9c3f148", "910fc5a"]
    y-axis "ms" 0 --> 184
    line [110, 161, 142, 88, 135, 159, 160, 153, 131, 151, 54, 71, 67, 59, 158, 140, 77, 167, 69, 148]
```
...
xychart-beta
    ...
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228", "f1d81b5", "f02224d", "cb092d9", "9c3f148", "910fc5a"]
    y-axis "ms" 0 --> 16051
    line [12421, 13612, 14591, 14540, 13488, 14410, 14392, 14255, 14254, 13354, 12763, 13959, 12313, 13510, 14082, 14090, 14084, 13204, 13156, 14081]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228", "f1d81b5", "f02224d", "cb092d9", "9c3f148", "910fc5a"]
    y-axis "ms" 0 --> 182
    line [106, 158, 145, 107, 135, 165, 137, 129, 155, 154, 63, 73, 57, 55, 125, 140, 121, 105, 90, 133]
```
...
xychart-beta
    ...
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228", "f1d81b5", "f02224d", "cb092d9", "9c3f148", "910fc5a"]
    y-axis "bytes" 0 --> 3626296
    line [3296025, 3296632, 3296023, 3295973, 3295761, 3295758, 3295757, 3291461, 3291455, 3291464, 3287427, 3287424, 3287423, 3287424, 3287869, 3287424, 3287426, 3287424, 3287424, 3287869]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228", "f1d81b5", "f02224d", "cb092d9", "9c3f148", "910fc5a"]
    y-axis "bytes" 0 --> 3617765
    line [3288856, 3288399, 3288861, 3288877, 3288270, 3288272, 3288270, 3283767, 3283770, 3283769, 3278198, 3278199, 3278191, 3278197, 3277689, 3278200, 3278200, 3278198, 3278199, 3277688]
```
