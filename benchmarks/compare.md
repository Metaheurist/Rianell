...
Generated at **2026-06-18T19:59:46.680Z**.
...
xychart-beta
    ...
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d"]
    y-axis "ms" 0 --> 14570
    line [13038, 12168, 11999, 12553, 11687, 13245, 12382, 12632, 12566, 12399]
```
```mermaid
xychart-beta
    ...
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d"]
    y-axis "ms" 0 --> 219
    line [120, 199, 132, 65, 111, 118, 138, 118, 75, 60]
```
...
xychart-beta
    ...
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d"]
    y-axis "ms" 0 --> 14027
    line [11979, 11847, 11759, 12402, 12580, 12444, 11529, 12751, 11500, 12552]
```
```mermaid
xychart-beta
    ...
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d"]
    y-axis "ms" 0 --> 156
    line [115, 110, 120, 71, 109, 126, 112, 141, 62, 68]
```
...
xychart-beta
    ...
    line [3368861, 3349208, 3324082, 3305549, 3300038, 3300034, 3300038, 3300630, 3300522, 3299950]
```
```mermaid
xychart-beta
    ...
    line [3360776, 3341646, 3316545, 3297734, 3293199, 3293198, 3293200, 3293409, 3293314, 3291396]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730"]
    y-axis "ms" 0 --> 14342
    line [13038, 12168, 11999, 12553, 11687]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730"]
    y-axis "ms" 0 --> 13839
    line [11979, 11847, 11759, 12402, 12580]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730"]
    y-axis "bytes" 0 --> 3705748
    line [3368861, 3349208, 3324082, 3305549, 3300038]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730"]
    y-axis "bytes" 0 --> 3696854
    line [3360776, 3341646, 3316545, 3297734, 3293199]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226"]
    y-axis "ms" 0 --> 15905
    line [13038, 12168, 11999, 12553, 11687, 13245, 12382, 12632, 12566, 12399, 12420, 14457, 14459, 13617, 14386, 14419, 13497, 13828, 13339, 14256]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226"]
    y-axis "ms" 0 --> 219
    line [120, 199, 132, 65, 111, 118, 138, 118, 75, 60, 110, 161, 142, 88, 135, 159, 160, 153, 131, 151]
```
...
xychart-beta
    ...
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226"]
    y-axis "ms" 0 --> 16051
    line [11979, 11847, 11759, 12402, 12580, 12444, 11529, 12751, 11500, 12552, 12421, 13612, 14591, 14540, 13488, 14410, 14392, 14255, 14254, 13354]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226"]
    y-axis "ms" 0 --> 182
    line [115, 110, 120, 71, 109, 126, 112, 141, 62, 68, 106, 158, 145, 107, 135, 165, 137, 129, 155, 154]
```
...
xychart-beta
    ...
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226"]
    y-axis "bytes" 0 --> 3705748
    line [3368861, 3349208, 3324082, 3305549, 3300038, 3300034, 3300038, 3300630, 3300522, 3299950, 3296025, 3296632, 3296023, 3295973, 3295761, 3295758, 3295757, 3291461, 3291455, 3291464]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226"]
    y-axis "bytes" 0 --> 3696854
    line [3360776, 3341646, 3316545, 3297734, 3293199, 3293198, 3293200, 3293409, 3293314, 3291396, 3288856, 3288399, 3288861, 3288877, 3288270, 3288272, 3288270, 3283767, 3283770, 3283769]
```
