...
Generated at **2026-06-14T01:03:43.070Z**.
...
xychart-beta
    ...
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c"]
    y-axis "ms" 0 --> 14734
    line [13394, 12124, 12007, 12072, 11911, 11695, 11707, 11844, 11862, 11845]
```
```mermaid
xychart-beta
    ...
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c"]
    y-axis "ms" 0 --> 174
    line [158, 20, 54, 110, 55, 38, 48, 41, 58, 47]
```
...
xychart-beta
    ...
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c"]
    y-axis "ms" 0 --> 14727
    line [13388, 12127, 12028, 11904, 11863, 11768, 11742, 11838, 11855, 11852]
```
```mermaid
xychart-beta
    ...
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c"]
    y-axis "ms" 0 --> 96
    line [87, 39, 77, 53, 46, 47, 40, 39, 52, 48]
```
...
xychart-beta
    ...
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c"]
    y-axis "bytes" 0 --> 2762834
    line [2511667, 2411913, 2377489, 2377488, 2370632, 2370632, 2370634, 2362082, 2362084, 2362047]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c"]
    y-axis "bytes" 0 --> 2754842
    line [2504401, 2405024, 2370491, 2370493, 2363429, 2363431, 2363430, 2356086, 2356086, 2356058]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d"]
    y-axis "ms" 0 --> 14734
    line [13394, 12124, 12007, 12072, 11911]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d"]
    y-axis "ms" 0 --> 14727
    line [13388, 12127, 12028, 11904, 11863]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d"]
    y-axis "bytes" 0 --> 2762834
    line [2511667, 2411913, 2377489, 2377488, 2370632]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d"]
    y-axis "bytes" 0 --> 2754842
    line [2504401, 2405024, 2370491, 2370493, 2363429]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e"]
    y-axis "ms" 0 --> 14734
    line [13394, 12124, 12007, 12072, 11911, 11695, 11707, 11844, 11862, 11845, 11860, 11572, 11701, 11691, 11716, 11698, 11566, 11571, 11711, 11699]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e"]
    y-axis "ms" 0 --> 174
    line [158, 20, 54, 110, 55, 38, 48, 41, 58, 47, 57, 68, 47, 39, 62, 46, 63, 53, 60, 68]
```
...
xychart-beta
    ...
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e"]
    y-axis "ms" 0 --> 14727
    line [13388, 12127, 12028, 11904, 11863, 11768, 11742, 11838, 11855, 11852, 11847, 11548, 11710, 11718, 11707, 11710, 11560, 11561, 11705, 11718]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e"]
    y-axis "ms" 0 --> 96
    line [87, 39, 77, 53, 46, 47, 40, 39, 52, 48, 58, 44, 54, 65, 54, 58, 56, 57, 52, 62]
```
...
xychart-beta
    ...
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e"]
    y-axis "bytes" 0 --> 2762834
    line [2511667, 2411913, 2377489, 2377488, 2370632, 2370632, 2370634, 2362082, 2362084, 2362047, 2362047, 2362048, 2362047, 2356686, 2356685, 2356472, 2356474, 2356472, 2356301, 2356304]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5095a3b", "84f6619", "68b4b12", "d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e"]
    y-axis "bytes" 0 --> 2754842
    line [2504401, 2405024, 2370491, 2370493, 2363429, 2363431, 2363430, 2356086, 2356086, 2356058, 2356058, 2356060, 2356059, 2350178, 2350175, 2350043, 2350046, 2350041, 2349868, 2349864]
```
