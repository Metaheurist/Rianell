...
Generated at **2026-06-28T15:07:12.867Z**.
...
xychart-beta
    ...
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766"]
    y-axis "ms" 0 --> 24593
    line [22326, 22357, 22240, 22209, 21878, 21870, 21566, 21132, 20925, 20504]
```
```mermaid
xychart-beta
    ...
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766"]
    y-axis "ms" 0 --> 579
    line [436, 479, 495, 507, 475, 500, 372, 526, 362, 353]
```
...
xychart-beta
    ...
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766"]
    y-axis "ms" 0 --> 24579
    line [22250, 22344, 22178, 22170, 21853, 21828, 21442, 21100, 20773, 20501]
```
```mermaid
xychart-beta
    ...
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766"]
    y-axis "ms" 0 --> 547
    line [377, 497, 391, 363, 343, 359, 369, 319, 359, 328]
```
...
xychart-beta
    ...
    line [4030634, 4030639, 4025609, 4026084, 4023969, 4020690, 4016661, 4010565, 3997221, 3982594]
```
```mermaid
xychart-beta
    ...
    line [4023650, 4023645, 4024761, 4017281, 4017565, 4012063, 4008470, 4002116, 3990384, 3978033]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f"]
    y-axis "ms" 0 --> 24593
    line [22326, 22357, 22240, 22209, 21878]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f"]
    y-axis "ms" 0 --> 24579
    line [22250, 22344, 22178, 22170, 21853]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f"]
    y-axis "bytes" 0 --> 4433703
    line [4030634, 4030639, 4025609, 4026084, 4023969]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f"]
    y-axis "bytes" 0 --> 4427238
    line [4023650, 4023645, 4024761, 4017281, 4017565]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3"]
    y-axis "ms" 0 --> 24593
    line [22326, 22357, 22240, 22209, 21878, 21870, 21566, 21132, 20925, 20504, 20549, 20346, 20361, 20380, 19099, 19257, 19097, 19090, 19227, 19255]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3"]
    y-axis "ms" 0 --> 735
    line [436, 479, 495, 507, 475, 500, 372, 526, 362, 353, 668, 351, 328, 340, 266, 279, 271, 292, 640, 311]
```
...
xychart-beta
    ...
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3"]
    y-axis "ms" 0 --> 24579
    line [22250, 22344, 22178, 22170, 21853, 21828, 21442, 21100, 20773, 20501, 20513, 20406, 20374, 20366, 19133, 19145, 19077, 19086, 19101, 19086]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3"]
    y-axis "ms" 0 --> 547
    line [377, 497, 391, 363, 343, 359, 369, 319, 359, 328, 369, 350, 334, 356, 281, 283, 259, 277, 276, 275]
```
...
xychart-beta
    ...
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3"]
    y-axis "bytes" 0 --> 4433703
    line [4030634, 4030639, 4025609, 4026084, 4023969, 4020690, 4016661, 4010565, 3997221, 3982594, 3982590, 3979178, 3979178, 3979178, 3858192, 3858192, 3858195, 3858763, 3858763, 3858762]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105", "bde5d06", "e18d728", "505b82a", "5cb7766", "d24306a", "0694684", "63ff7b1", "68da6e1", "a38f9aa", "d04511e", "b15d2db", "09a1190", "51e147b", "4db54b3"]
    y-axis "bytes" 0 --> 4427238
    line [4023650, 4023645, 4024761, 4017281, 4017565, 4012063, 4008470, 4002116, 3990384, 3978033, 3978036, 3971946, 3971945, 3971946, 3849365, 3849367, 3849366, 3850104, 3850105, 3850105]
```
