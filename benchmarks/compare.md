...
Generated at **2026-06-17T18:48:14.468Z**.
...
xychart-beta
    ...
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba"]
    y-axis "ms" 0 --> 15861
    line [13617, 14386, 14419, 13497, 13828, 13339, 14256, 13811, 13665, 12311]
```
```mermaid
xychart-beta
    ...
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba"]
    y-axis "ms" 0 --> 176
    line [88, 135, 159, 160, 153, 131, 151, 54, 71, 67]
```
...
xychart-beta
    ...
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba"]
    y-axis "ms" 0 --> 15995
    line [14540, 13488, 14410, 14392, 14255, 14254, 13354, 12763, 13959, 12313]
```
```mermaid
xychart-beta
    ...
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba"]
    y-axis "ms" 0 --> 182
    line [107, 135, 165, 137, 129, 155, 154, 63, 73, 57]
```
...
xychart-beta
    ...
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba"]
    y-axis "bytes" 0 --> 3625571
    line [3295973, 3295761, 3295758, 3295757, 3291461, 3291455, 3291464, 3287427, 3287424, 3287423]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba"]
    y-axis "bytes" 0 --> 3617765
    line [3288877, 3288270, 3288272, 3288270, 3283767, 3283770, 3283769, 3278198, 3278199, 3278191]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7"]
    y-axis "ms" 0 --> 15861
    line [13617, 14386, 14419, 13497, 13828]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7"]
    y-axis "ms" 0 --> 15995
    line [14540, 13488, 14410, 14392, 14255]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7"]
    y-axis "bytes" 0 --> 3625571
    line [3295973, 3295761, 3295758, 3295757, 3291461]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7"]
    y-axis "bytes" 0 --> 3617765
    line [3288877, 3288270, 3288272, 3288270, 3283767]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228", "f1d81b5", "f02224d", "cb092d9", "9c3f148", "910fc5a", "1d3b3ff", "97c29c1", "4c6144b"]
    y-axis "ms" 0 --> 15861
    line [13617, 14386, 14419, 13497, 13828, 13339, 14256, 13811, 13665, 12311, 13514, 14099, 14091, 13178, 14089, 13157, 14103, 13484, 14084, 14094]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228", "f1d81b5", "f02224d", "cb092d9", "9c3f148", "910fc5a", "1d3b3ff", "97c29c1", "4c6144b"]
    y-axis "ms" 0 --> 184
    line [88, 135, 159, 160, 153, 131, 151, 54, 71, 67, 59, 158, 140, 77, 167, 69, 148, 90, 135, 167]
```
...
xychart-beta
    ...
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228", "f1d81b5", "f02224d", "cb092d9", "9c3f148", "910fc5a", "1d3b3ff", "97c29c1", "4c6144b"]
    y-axis "ms" 0 --> 15995
    line [14540, 13488, 14410, 14392, 14255, 14254, 13354, 12763, 13959, 12313, 13510, 14082, 14090, 14084, 13204, 13156, 14081, 13177, 14085, 14088]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228", "f1d81b5", "f02224d", "cb092d9", "9c3f148", "910fc5a", "1d3b3ff", "97c29c1", "4c6144b"]
    y-axis "ms" 0 --> 182
    line [107, 135, 165, 137, 129, 155, 154, 63, 73, 57, 55, 125, 140, 121, 105, 90, 133, 98, 117, 143]
```
...
xychart-beta
    title "Expo — Android Hermes gzip total (bytes)"
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228", "f1d81b5", "f02224d", "cb092d9", "9c3f148", "910fc5a", "1d3b3ff", "97c29c1", "00011b8"]
    y-axis "bytes" 0 --> 3625571
    line [3295973, 3295761, 3295758, 3295757, 3291461, 3291455, 3291464, 3287427, 3287424, 3287423, 3287424, 3287869, 3287424, 3287426, 3287424, 3287424, 3287869, 3287424, 3266092, 3266094]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228", "f1d81b5", "f02224d", "cb092d9", "9c3f148", "910fc5a", "1d3b3ff", "97c29c1", "00011b8"]
    y-axis "bytes" 0 --> 3617765
    line [3288877, 3288270, 3288272, 3288270, 3283767, 3283770, 3283769, 3278198, 3278199, 3278191, 3278197, 3277689, 3278200, 3278200, 3278198, 3278199, 3277688, 3278198, 3258272, 3258276]
```
