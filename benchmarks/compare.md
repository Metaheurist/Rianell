...
Generated at **2026-06-13T10:48:13.608Z**.
...
xychart-beta
    ...
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd"]
    y-axis "ms" 0 --> 13280
    line [12072, 11911, 11695, 11707, 11844, 11862, 11845, 11860, 11572, 11701]
```
```mermaid
xychart-beta
    ...
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd"]
    y-axis "ms" 0 --> 122
    line [110, 55, 38, 48, 41, 58, 47, 57, 68, 47]
```
...
xychart-beta
    ...
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd"]
    y-axis "ms" 0 --> 13095
    line [11904, 11863, 11768, 11742, 11838, 11855, 11852, 11847, 11548, 11710]
```
```mermaid
xychart-beta
    ...
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd"]
    y-axis "ms" 0 --> 64
    line [53, 46, 47, 40, 39, 52, 48, 58, 44, 54]
```
...
xychart-beta
    ...
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd"]
    y-axis "ms" 0 --> 10093
    line [9175, 9028, 9021, 8982, 8976, 8972, 8979, 8838, 8693, 8838]
```
```mermaid
xychart-beta
    ...
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd"]
    y-axis "ms" 0 --> 44
    line [23, 28, 32, 23, 21, 35, 26, 35, 40, 35]
```
...
xychart-beta
    ...
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd"]
    y-axis "bytes" 0 --> 2615237
    line [2377488, 2370632, 2370632, 2370634, 2362082, 2362084, 2362047, 2362047, 2362048, 2362047]
```
```mermaid
xychart-beta
    ...
    line [2370493, 2363429, 2363431, 2363430, 2356086, 2356086, 2356058, 2356058, 2356060, 2356059]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3"]
    y-axis "ms" 0 --> 13280
    line [12072, 11911, 11695, 11707, 11844]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3"]
    y-axis "ms" 0 --> 13095
    line [11904, 11863, 11768, 11742, 11838]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3"]
    y-axis "bytes" 0 --> 2615237
    line [2377488, 2370632, 2370632, 2370634, 2362082]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3"]
    y-axis "bytes" 0 --> 2607543
    line [2370493, 2363429, 2363431, 2363430, 2356086]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 13280
    line [12072, 11911, 11695, 11707, 11844, 11862, 11845, 11860, 11572, 11701, 11691, 11716, 11698, 11566, 11571, 11711, 11699, 11703, 11722, 11697]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 122
    line [110, 55, 38, 48, 41, 58, 47, 57, 68, 47, 39, 62, 46, 63, 53, 60, 68, 69, 68, 68]
```
...
xychart-beta
    ...
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 13095
    line [11904, 11863, 11768, 11742, 11838, 11855, 11852, 11847, 11548, 11710, 11718, 11707, 11710, 11560, 11561, 11705, 11718, 11715, 11701, 11707]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 72
    line [53, 46, 47, 40, 39, 52, 48, 58, 44, 54, 65, 54, 58, 56, 57, 52, 62, 61, 60, 54]
```
...
xychart-beta
    ...
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 10093
    line [9175, 9028, 9021, 8982, 8976, 8972, 8979, 8838, 8693, 8838, 8681, 8837, 8731, 8688, 8693, 8834, 8838, 8835, 8833, 8830]
```
```mermaid
xychart-beta
    title "Capacitor (legacy) — TBT (ms)"
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "ms" 0 --> 59
    line [23, 28, 32, 23, 21, 35, 26, 35, 40, 35, 25, 45, 53, 34, 26, 38, 34, 31, 32, 27]
```
...
xychart-beta
    ...
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "bytes" 0 --> 2615237
    line [2377488, 2370632, 2370632, 2370634, 2362082, 2362084, 2362047, 2362047, 2362048, 2362047, 2356686, 2356685, 2356472, 2356474, 2356472, 2356301, 2356304, 2356302, 2356302, 2356299]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["d6308aa", "75b5f2d", "b24157b", "c5293a0", "ad35dc3", "78b9979", "a32d90c", "df44b11", "4da014f", "738c1fd", "bf7d465", "a728c40", "37034e2", "00595d4", "0e5a7e3", "00535b0", "c27c51e", "2c90097", "e99a306", "b11ca5d"]
    y-axis "bytes" 0 --> 2607543
    line [2370493, 2363429, 2363431, 2363430, 2356086, 2356086, 2356058, 2356058, 2356060, 2356059, 2350178, 2350175, 2350043, 2350046, 2350041, 2349868, 2349864, 2349868, 2349869, 2349865]
```
