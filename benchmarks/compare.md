...
Generated at **2026-06-23T23:28:02.098Z**.
...
xychart-beta
    ...
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8"]
    y-axis "ms" 0 --> 20984
    line [19076, 18898, 18874, 18888, 18728, 18722, 18436, 18270, 18278, 18267]
```
```mermaid
xychart-beta
    ...
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8"]
    y-axis "ms" 0 --> 370
    line [235, 237, 243, 207, 241, 336, 225, 210, 218, 207]
```
...
xychart-beta
    ...
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8"]
    y-axis "ms" 0 --> 21119
    line [19199, 18871, 18888, 18892, 18741, 18704, 18438, 18287, 18290, 18265]
```
```mermaid
xychart-beta
    ...
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8"]
    y-axis "ms" 0 --> 264
    line [240, 216, 215, 224, 236, 229, 227, 221, 230, 221]
```
...
xychart-beta
    ...
    line [3858764, 3845905, 3843474, 3841087, 3837618, 3836645, 3819535, 3807947, 3807947, 3802529]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8"]
    y-axis "bytes" 0 --> 4235115
    line [3850104, 3837764, 3833771, 3832292, 3830296, 3828818, 3810818, 3801309, 3801305, 3796002]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8"]
    y-axis "ms" 0 --> 20984
    line [19076, 18898, 18874, 18888, 18728]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8"]
    y-axis "ms" 0 --> 21119
    line [19199, 18871, 18888, 18892, 18741]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8"]
    y-axis "bytes" 0 --> 4244641
    line [3858764, 3845905, 3843474, 3841087, 3837618]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8"]
    y-axis "bytes" 0 --> 4235115
    line [3850104, 3837764, 3833771, 3832292, 3830296]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2"]
    y-axis "ms" 0 --> 20984
    line [19076, 18898, 18874, 18888, 18728, 18722, 18436, 18270, 18278, 18267, 18242, 18254, 14947, 14588, 14818, 13807, 13825, 13971, 13962, 13654]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2"]
    y-axis "ms" 0 --> 370
    line [235, 237, 243, 207, 241, 336, 225, 210, 218, 207, 182, 163, 59, 132, 117, 160, 166, 155, 155, 151]
```
...
xychart-beta
    ...
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2"]
    y-axis "ms" 0 --> 21119
    line [19199, 18871, 18888, 18892, 18741, 18704, 18438, 18287, 18290, 18265, 18222, 18275, 14936, 14957, 13769, 13952, 13820, 13811, 13660, 13653]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2"]
    y-axis "ms" 0 --> 264
    line [240, 216, 215, 224, 236, 229, 227, 221, 230, 221, 159, 209, 61, 106, 121, 168, 141, 163, 156, 157]
```
...
xychart-beta
    ...
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2"]
    y-axis "bytes" 0 --> 4244641
    line [3858764, 3845905, 3843474, 3841087, 3837618, 3836645, 3819535, 3807947, 3807947, 3802529, 3802528, 3802527, 3796378, 3791714, 3791716, 3770636, 3770634, 3771343, 3770634, 3767812]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["2460429", "d444707", "17ca890", "5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2"]
    y-axis "bytes" 0 --> 4235115
    line [3850104, 3837764, 3833771, 3832292, 3830296, 3828818, 3810818, 3801309, 3801305, 3796002, 3796002, 3796005, 3788525, 3783517, 3783520, 3762734, 3762736, 3762498, 3762733, 3759872]
```
