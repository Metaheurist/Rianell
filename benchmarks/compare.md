...
Generated at **2026-06-19T17:25:39.787Z**.
...
xychart-beta
    ...
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd"]
    y-axis "ms" 0 --> 15502
    line [13053, 14092, 13942, 13945, 13945, 14014, 13997, 13868, 12854, 12437]
```
```mermaid
xychart-beta
    ...
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd"]
    y-axis "ms" 0 --> 195
    line [153, 147, 148, 146, 159, 177, 148, 150, 64, 116]
```
...
xychart-beta
    ...
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd"]
    y-axis "ms" 0 --> 15667
    line [14098, 14242, 12895, 14078, 12749, 13943, 12738, 12578, 13605, 12438]
```
```mermaid
xychart-beta
    ...
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd"]
    y-axis "ms" 0 --> 182
    line [156, 165, 149, 132, 146, 144, 134, 124, 72, 122]
```
...
xychart-beta
    ...
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd"]
    y-axis "bytes" 0 --> 3846033
    line [3496393, 3494445, 3491111, 3478911, 3474606, 3468338, 3454266, 3434635, 3421569, 3417622]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd"]
    y-axis "bytes" 0 --> 3837082
    line [3488256, 3486228, 3483393, 3471867, 3466755, 3460455, 3446796, 3426562, 3414256, 3409221]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad"]
    y-axis "ms" 0 --> 15502
    line [13053, 14092, 13942, 13945, 13945]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad"]
    y-axis "ms" 0 --> 15667
    line [14098, 14242, 12895, 14078, 12749]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad"]
    y-axis "bytes" 0 --> 3846033
    line [3496393, 3494445, 3491111, 3478911, 3474606]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad"]
    y-axis "bytes" 0 --> 3837082
    line [3488256, 3486228, 3483393, 3471867, 3466755]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a"]
    y-axis "ms" 0 --> 15502
    line [13053, 14092, 13942, 13945, 13945, 14014, 13997, 13868, 12854, 12437, 12430, 12295, 13197, 13323, 13038, 12168, 11999, 12553, 11687, 13245]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a"]
    y-axis "ms" 0 --> 219
    line [153, 147, 148, 146, 159, 177, 148, 150, 64, 116, 131, 136, 154, 127, 120, 199, 132, 65, 111, 118]
```
...
xychart-beta
    ...
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a"]
    y-axis "ms" 0 --> 15667
    line [14098, 14242, 12895, 14078, 12749, 13943, 12738, 12578, 13605, 12438, 12126, 12180, 12127, 13036, 11979, 11847, 11759, 12402, 12580, 12444]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a"]
    y-axis "ms" 0 --> 182
    line [156, 165, 149, 132, 146, 144, 134, 124, 72, 122, 129, 130, 118, 122, 115, 110, 120, 71, 109, 126]
```
...
xychart-beta
    ...
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a"]
    y-axis "bytes" 0 --> 3846033
    line [3496393, 3494445, 3491111, 3478911, 3474606, 3468338, 3454266, 3434635, 3421569, 3417622, 3400545, 3388765, 3375300, 3368860, 3368861, 3349208, 3324082, 3305549, 3300038, 3300034]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889", "4b2eed4", "e566410", "fd7e730", "e9f962a"]
    y-axis "bytes" 0 --> 3837082
    line [3488256, 3486228, 3483393, 3471867, 3466755, 3460455, 3446796, 3426562, 3414256, 3409221, 3391123, 3378280, 3368083, 3360774, 3360776, 3341646, 3316545, 3297734, 3293199, 3293198]
```
