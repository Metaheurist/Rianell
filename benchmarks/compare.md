...
Generated at **2026-06-21T22:52:52.087Z**.
...
xychart-beta
    ...
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc"]
    y-axis "ms" 0 --> 20777
    line [18888, 18728, 18722, 18436, 18270, 18278, 18267, 18242, 18254, 14947]
```
```mermaid
xychart-beta
    ...
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc"]
    y-axis "ms" 0 --> 370
    line [207, 241, 336, 225, 210, 218, 207, 182, 163, 59]
```
...
xychart-beta
    ...
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc"]
    y-axis "ms" 0 --> 20782
    line [18892, 18741, 18704, 18438, 18287, 18290, 18265, 18222, 18275, 14936]
```
```mermaid
xychart-beta
    ...
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc"]
    y-axis "ms" 0 --> 260
    line [224, 236, 229, 227, 221, 230, 221, 159, 209, 61]
```
...
xychart-beta
    ...
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc"]
    y-axis "bytes" 0 --> 4225196
    line [3841087, 3837618, 3836645, 3819535, 3807947, 3807947, 3802529, 3802528, 3802527, 3796378]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc"]
    y-axis "bytes" 0 --> 4215522
    line [3832292, 3830296, 3828818, 3810818, 3801309, 3801305, 3796002, 3796002, 3796005, 3788525]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26"]
    y-axis "ms" 0 --> 20777
    line [18888, 18728, 18722, 18436, 18270]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26"]
    y-axis "ms" 0 --> 20782
    line [18892, 18741, 18704, 18438, 18287]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26"]
    y-axis "bytes" 0 --> 4225196
    line [3841087, 3837618, 3836645, 3819535, 3807947]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26"]
    y-axis "bytes" 0 --> 4215522
    line [3832292, 3830296, 3828818, 3810818, 3801309]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "ms" 0 --> 20777
    line [18888, 18728, 18722, 18436, 18270, 18278, 18267, 18242, 18254, 14947, 14588, 14818, 13807, 13825, 13971, 13962, 13654, 13664, 13678, 13670]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "ms" 0 --> 370
    line [207, 241, 336, 225, 210, 218, 207, 182, 163, 59, 132, 117, 160, 166, 155, 155, 151, 142, 139, 136]
```
...
xychart-beta
    ...
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "ms" 0 --> 20782
    line [18892, 18741, 18704, 18438, 18287, 18290, 18265, 18222, 18275, 14936, 14957, 13769, 13952, 13820, 13811, 13660, 13653, 14556, 13636, 14711]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "ms" 0 --> 260
    line [224, 236, 229, 227, 221, 230, 221, 159, 209, 61, 106, 121, 168, 141, 163, 156, 157, 149, 146, 164]
```
...
xychart-beta
    ...
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "bytes" 0 --> 4225196
    line [3841087, 3837618, 3836645, 3819535, 3807947, 3807947, 3802529, 3802528, 3802527, 3796378, 3791714, 3791716, 3770636, 3770634, 3771343, 3770634, 3767812, 3557908, 3544463, 3543472]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["5a2daa3", "f7738a8", "22c28c1", "02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "bytes" 0 --> 4215522
    line [3832292, 3830296, 3828818, 3810818, 3801309, 3801305, 3796002, 3796002, 3796005, 3788525, 3783517, 3783520, 3762734, 3762736, 3762498, 3762733, 3759872, 3548602, 3534279, 3535273]
```
