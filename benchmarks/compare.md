...
Generated at **2026-07-16T16:16:51.937Z**.
...
xychart-beta
    ...
    x-axis ["1cdec4f", "9f297f6", "2ffa0f6", "657e0de", "1e27fcd", "cc3e106", "5d91329", "782a519", "54b5b9a", "95c674d"]
    y-axis "ms" 0 --> 31584
    line [24933, 24873, 24910, 24797, 24744, 23765, 27536, 24725, 28712, 24213]
```
```mermaid
xychart-beta
    ...
    x-axis ["1cdec4f", "9f297f6", "2ffa0f6", "657e0de", "1e27fcd", "cc3e106", "5d91329", "782a519", "54b5b9a", "95c674d"]
    y-axis "ms" 0 --> 3101
    line [1497, 1240, 1647, 1279, 1784, 1630, 1186, 2090, 2819, 1235]
```
...
xychart-beta
    ...
    x-axis ["1cdec4f", "9f297f6", "2ffa0f6", "657e0de", "1e27fcd", "cc3e106", "fda11c1", "5d91329", "782a519", "54b5b9a"]
    y-axis "bytes" 0 --> 4509037
    line [4099120, 4099121, 4099124, 4098083, 4094465, 4094465, 4090789, 4090787, 4090360, 4089313]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["1cdec4f", "9f297f6", "2ffa0f6", "657e0de", "1e27fcd", "cc3e106", "fda11c1", "5d91329", "782a519", "54b5b9a"]
    y-axis "bytes" 0 --> 4500158
    line [4091052, 4091052, 4091051, 4090884, 4087417, 4087412, 4084812, 4084805, 4084677, 4082348]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["1cdec4f", "9f297f6", "2ffa0f6", "657e0de", "1e27fcd"]
    y-axis "ms" 0 --> 27427
    line [24933, 24873, 24910, 24797, 24744]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["1cdec4f", "9f297f6", "2ffa0f6", "657e0de", "1e27fcd"]
    y-axis "bytes" 0 --> 4509037
    line [4099120, 4099121, 4099124, 4098083, 4094465]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["1cdec4f", "9f297f6", "2ffa0f6", "657e0de", "1e27fcd"]
    y-axis "bytes" 0 --> 4500158
    line [4091052, 4091052, 4091051, 4090884, 4087417]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["1cdec4f", "9f297f6", "2ffa0f6", "657e0de", "1e27fcd", "cc3e106", "5d91329", "782a519", "54b5b9a", "95c674d", "1035b91", "c0d5c84", "a0abe91", "f776321", "894d90a", "130b3fd", "62dc462", "b5a9254", "c45967e", "2d2a9da"]
    y-axis "ms" 0 --> 31584
    line [24933, 24873, 24910, 24797, 24744, 23765, 27536, 24725, 28712, 24213, 11936, 21994, 0, 0, 21131, 0, 20871, 20837, 0, 0]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["1cdec4f", "9f297f6", "2ffa0f6", "657e0de", "1e27fcd", "cc3e106", "5d91329", "782a519", "54b5b9a", "95c674d", "1035b91", "c0d5c84", "a0abe91", "f776321", "894d90a", "130b3fd", "62dc462", "b5a9254", "c45967e", "2d2a9da"]
    y-axis "ms" 0 --> 3101
    line [1497, 1240, 1647, 1279, 1784, 1630, 1186, 2090, 2819, 1235, 859, 521, 0, 0, 609, 0, 891, 628, 0, 0]
```
...
xychart-beta
    ...
    x-axis ["1cdec4f", "9f297f6", "2ffa0f6", "657e0de", "1e27fcd", "cc3e106", "5d91329", "782a519", "54b5b9a", "95c674d", "1035b91", "c0d5c84", "a0abe91", "f776321", "894d90a", "130b3fd", "62dc462", "b5a9254", "c45967e", "2d2a9da"]
    y-axis "ms" 0 --> 31584
    line [24933, 24873, 24910, 24797, 24744, 23765, 27536, 24725, 28712, 24213, 11936, 0, 0, 0, 0, 0, 0, 0, 0, 0]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["1cdec4f", "9f297f6", "2ffa0f6", "657e0de", "1e27fcd", "cc3e106", "5d91329", "782a519", "54b5b9a", "95c674d", "1035b91", "c0d5c84", "a0abe91", "f776321", "894d90a", "130b3fd", "62dc462", "b5a9254", "c45967e", "2d2a9da"]
    y-axis "ms" 0 --> 3101
    line [1497, 1240, 1647, 1279, 1784, 1630, 1186, 2090, 2819, 1235, 859, 0, 0, 0, 0, 0, 0, 0, 0, 0]
```
...
xychart-beta
    title "Expo — Android Hermes gzip total (bytes)"
    x-axis ["1cdec4f", "9f297f6", "2ffa0f6", "657e0de", "1e27fcd", "cc3e106", "fda11c1", "5d91329", "782a519", "54b5b9a", "95c674d", "1035b91", "c0d5c84", "a0abe91", "f776321", "894d90a", "130b3fd", "458975f", "62dc462", "b5a9254"]
    y-axis "bytes" 0 --> 4509037
    line [4099120, 4099121, 4099124, 4098083, 4094465, 4094465, 4090789, 4090787, 4090360, 4089313, 4088814, 4088813, 4088813, 4088812, 4085830, 4086643, 4077332, 4077341, 4077340, 4078885]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["1cdec4f", "9f297f6", "2ffa0f6", "657e0de", "1e27fcd", "cc3e106", "fda11c1", "5d91329", "782a519", "54b5b9a", "95c674d", "1035b91", "c0d5c84", "a0abe91", "f776321", "894d90a", "130b3fd", "458975f", "62dc462", "b5a9254"]
    y-axis "bytes" 0 --> 4500158
    line [4091052, 4091052, 4091051, 4090884, 4087417, 4087412, 4084812, 4084805, 4084677, 4082348, 4083105, 4083108, 4083106, 4083107, 4079675, 4079243, 4074172, 4073443, 4073443, 4069109]
```
