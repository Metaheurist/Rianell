...
Generated at **2026-07-06T00:32:31.521Z**.
...
xychart-beta
    ...
    x-axis ["62dc462", "b5a9254", "c45967e", "2d2a9da", "0a41d6c", "3c28203", "51e19c3", "c7be5f0", "f56ca64", "e074e16"]
    y-axis "ms" 0 --> 23205
    line [20871, 20837, 0, 0, 0, 20503, 20509, 21095, 19101, 19549]
```
```mermaid
xychart-beta
    ...
    x-axis ["62dc462", "b5a9254", "c45967e", "2d2a9da", "0a41d6c", "3c28203", "51e19c3", "c7be5f0", "f56ca64", "e074e16"]
    y-axis "ms" 0 --> 981
    line [891, 628, 0, 0, 0, 422, 418, 411, 348, 402]
```
...
xychart-beta
    ...
    line [4077340, 4078885, 4078896, 4078895, 4078897, 4076071, 4075584, 4075582, 4052821, 4052813]
```
```mermaid
xychart-beta
    ...
    line [4073443, 4069109, 4069113, 4069106, 4069107, 4065403, 4065816, 4065817, 4047233, 4047234]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["62dc462", "b5a9254", "c45967e", "2d2a9da", "0a41d6c"]
    y-axis "ms" 0 --> 22959
    line [20871, 20837, 0, 0, 0]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["62dc462", "b5a9254", "c45967e", "2d2a9da", "0a41d6c"]
    y-axis "bytes" 0 --> 4486787
    line [4077340, 4078885, 4078896, 4078895, 4078897]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["62dc462", "b5a9254", "c45967e", "2d2a9da", "0a41d6c"]
    y-axis "bytes" 0 --> 4480788
    line [4073443, 4069109, 4069113, 4069106, 4069107]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["62dc462", "b5a9254", "c45967e", "2d2a9da", "0a41d6c", "3c28203", "51e19c3", "c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105"]
    y-axis "ms" 0 --> 24593
    line [20871, 20837, 0, 0, 0, 20503, 20509, 21095, 19101, 19549, 19542, 18663, 19248, 22351, 22326, 22357, 22240, 22209, 21878, 21870]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["62dc462", "b5a9254", "c45967e", "2d2a9da", "0a41d6c", "3c28203", "51e19c3", "c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105"]
    y-axis "ms" 0 --> 981
    line [891, 628, 0, 0, 0, 422, 418, 411, 348, 402, 443, 333, 395, 399, 436, 479, 495, 507, 475, 500]
```
...
xychart-beta
    ...
    x-axis ["62dc462", "b5a9254", "c45967e", "2d2a9da", "0a41d6c", "3c28203", "51e19c3", "c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105"]
    y-axis "bytes" 0 --> 4486787
    line [4077340, 4078885, 4078896, 4078895, 4078897, 4076071, 4075584, 4075582, 4052821, 4052813, 4049448, 4046554, 4048091, 4030638, 4030634, 4030639, 4025609, 4026084, 4023969, 4020690]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["62dc462", "b5a9254", "c45967e", "2d2a9da", "0a41d6c", "3c28203", "51e19c3", "c7be5f0", "f56ca64", "e074e16", "7cc0f37", "4a71141", "e3e901b", "58e1088", "c45239d", "d6a3c0b", "00d3c19", "c83d9d8", "d22897f", "3e44105"]
    y-axis "bytes" 0 --> 4480788
    line [4073443, 4069109, 4069113, 4069106, 4069107, 4065403, 4065816, 4065817, 4047233, 4047234, 4042958, 4039809, 4039179, 4023650, 4023650, 4023645, 4024761, 4017281, 4017565, 4012063]
```
