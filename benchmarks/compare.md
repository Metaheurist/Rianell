...
Generated at **2026-06-20T16:26:42.253Z**.
...
xychart-beta
    ...
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "ms" 0 --> 16300
    line [14588, 14818, 13807, 13825, 13971, 13962, 13654, 13664, 13678, 13670]
```
```mermaid
xychart-beta
    ...
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "ms" 0 --> 183
    line [132, 117, 160, 166, 155, 155, 151, 142, 139, 136]
```
...
xychart-beta
    ...
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "ms" 0 --> 16453
    line [14957, 13769, 13952, 13820, 13811, 13660, 13653, 14556, 13636, 14711]
```
```mermaid
xychart-beta
    ...
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "ms" 0 --> 185
    line [106, 121, 168, 141, 163, 156, 157, 149, 146, 164]
```
...
xychart-beta
    ...
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "bytes" 0 --> 4170888
    line [3791714, 3791716, 3770636, 3770634, 3771343, 3770634, 3767812, 3557908, 3544463, 3543472]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336"]
    y-axis "bytes" 0 --> 4161873
    line [3783517, 3783520, 3762734, 3762736, 3762498, 3762733, 3759872, 3548602, 3534279, 3535273]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756"]
    y-axis "ms" 0 --> 16300
    line [14588, 14818, 13807, 13825, 13971]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756"]
    y-axis "ms" 0 --> 16453
    line [14957, 13769, 13952, 13820, 13811]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756"]
    y-axis "bytes" 0 --> 4170888
    line [3791714, 3791716, 3770636, 3770634, 3771343]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756"]
    y-axis "bytes" 0 --> 4161873
    line [3783517, 3783520, 3762734, 3762736, 3762498]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0"]
    y-axis "ms" 0 --> 16491
    line [14588, 14818, 13807, 13825, 13971, 13962, 13654, 13664, 13678, 13670, 14406, 14991, 13053, 14092, 13942, 13945, 13945, 14014, 13997, 13868]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0"]
    y-axis "ms" 0 --> 195
    line [132, 117, 160, 166, 155, 155, 151, 142, 139, 136, 169, 135, 153, 147, 148, 146, 159, 177, 148, 150]
```
...
xychart-beta
    ...
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0"]
    y-axis "ms" 0 --> 16453
    line [14957, 13769, 13952, 13820, 13811, 13660, 13653, 14556, 13636, 14711, 13355, 13197, 14098, 14242, 12895, 14078, 12749, 13943, 12738, 12578]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0"]
    y-axis "ms" 0 --> 185
    line [106, 121, 168, 141, 163, 156, 157, 149, 146, 164, 152, 124, 156, 165, 149, 132, 146, 144, 134, 124]
```
...
xychart-beta
    ...
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0"]
    y-axis "bytes" 0 --> 4170888
    line [3791714, 3791716, 3770636, 3770634, 3771343, 3770634, 3767812, 3557908, 3544463, 3543472, 3523541, 3511474, 3496393, 3494445, 3491111, 3478911, 3474606, 3468338, 3454266, 3434635]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0"]
    y-axis "bytes" 0 --> 4161873
    line [3783517, 3783520, 3762734, 3762736, 3762498, 3762733, 3759872, 3548602, 3534279, 3535273, 3515861, 3502937, 3488256, 3486228, 3483393, 3471867, 3466755, 3460455, 3446796, 3426562]
```
