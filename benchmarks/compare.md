...
Generated at **2026-06-19T20:36:54.555Z**.
...
xychart-beta
    ...
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b"]
    y-axis "ms" 0 --> 16491
    line [13678, 13670, 14406, 14991, 13053, 14092, 13942, 13945, 13945, 14014]
```
```mermaid
xychart-beta
    ...
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b"]
    y-axis "ms" 0 --> 195
    line [139, 136, 169, 135, 153, 147, 148, 146, 159, 177]
```
...
xychart-beta
    ...
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b"]
    y-axis "ms" 0 --> 16183
    line [13636, 14711, 13355, 13197, 14098, 14242, 12895, 14078, 12749, 13943]
```
```mermaid
xychart-beta
    ...
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b"]
    y-axis "ms" 0 --> 182
    line [146, 164, 152, 124, 156, 165, 149, 132, 146, 144]
```
...
xychart-beta
    ...
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b"]
    y-axis "bytes" 0 --> 3898910
    line [3544463, 3543472, 3523541, 3511474, 3496393, 3494445, 3491111, 3478911, 3474606, 3468338]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b"]
    y-axis "bytes" 0 --> 3888801
    line [3534279, 3535273, 3515861, 3502937, 3488256, 3486228, 3483393, 3471867, 3466755, 3460455]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee"]
    y-axis "ms" 0 --> 16491
    line [13678, 13670, 14406, 14991, 13053]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee"]
    y-axis "ms" 0 --> 16183
    line [13636, 14711, 13355, 13197, 14098]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee"]
    y-axis "bytes" 0 --> 3898910
    line [3544463, 3543472, 3523541, 3511474, 3496393]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee"]
    y-axis "bytes" 0 --> 3888801
    line [3534279, 3535273, 3515861, 3502937, 3488256]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889"]
    y-axis "ms" 0 --> 16491
    line [13678, 13670, 14406, 14991, 13053, 14092, 13942, 13945, 13945, 14014, 13997, 13868, 12854, 12437, 12430, 12295, 13197, 13323, 13038, 12168]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889"]
    y-axis "ms" 0 --> 219
    line [139, 136, 169, 135, 153, 147, 148, 146, 159, 177, 148, 150, 64, 116, 131, 136, 154, 127, 120, 199]
```
...
xychart-beta
    ...
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889"]
    y-axis "ms" 0 --> 16183
    line [13636, 14711, 13355, 13197, 14098, 14242, 12895, 14078, 12749, 13943, 12738, 12578, 13605, 12438, 12126, 12180, 12127, 13036, 11979, 11847]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889"]
    y-axis "ms" 0 --> 182
    line [146, 164, 152, 124, 156, 165, 149, 132, 146, 144, 134, 124, 72, 122, 129, 130, 118, 122, 115, 110]
```
...
xychart-beta
    ...
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889"]
    y-axis "bytes" 0 --> 3898910
    line [3544463, 3543472, 3523541, 3511474, 3496393, 3494445, 3491111, 3478911, 3474606, 3468338, 3454266, 3434635, 3421569, 3417622, 3400545, 3388765, 3375300, 3368860, 3368861, 3349208]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee", "267344d", "5ee6fa1", "96e2f7d", "a62a0ad", "b66f34b", "33962ad", "02b4ca0", "42e4179", "8a821bd", "0cd488d", "fae42c2", "ac4c6a0", "0f26a4d", "d13794d", "b296889"]
    y-axis "bytes" 0 --> 3888801
    line [3534279, 3535273, 3515861, 3502937, 3488256, 3486228, 3483393, 3471867, 3466755, 3460455, 3446796, 3426562, 3414256, 3409221, 3391123, 3378280, 3368083, 3360774, 3360776, 3341646]
```
