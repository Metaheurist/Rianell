...
Generated at **2026-06-21T20:51:08.057Z**.
...
xychart-beta
    ...
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510"]
    y-axis "ms" 0 --> 20280
    line [18436, 18270, 18278, 18267, 18242, 18254, 14947, 14588, 14818, 13807]
```
```mermaid
xychart-beta
    ...
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510"]
    y-axis "ms" 0 --> 248
    line [225, 210, 218, 207, 182, 163, 59, 132, 117, 160]
```
...
xychart-beta
    ...
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510"]
    y-axis "ms" 0 --> 20282
    line [18438, 18287, 18290, 18265, 18222, 18275, 14936, 14957, 13769, 13952]
```
```mermaid
xychart-beta
    ...
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510"]
    y-axis "ms" 0 --> 254
    line [227, 221, 230, 221, 159, 209, 61, 106, 121, 168]
```
...
xychart-beta
    ...
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510"]
    y-axis "bytes" 0 --> 4201489
    line [3819535, 3807947, 3807947, 3802529, 3802528, 3802527, 3796378, 3791714, 3791716, 3770636]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510"]
    y-axis "bytes" 0 --> 4191900
    line [3810818, 3801309, 3801305, 3796002, 3796002, 3796005, 3788525, 3783517, 3783520, 3762734]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643"]
    y-axis "ms" 0 --> 20280
    line [18436, 18270, 18278, 18267, 18242]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643"]
    y-axis "ms" 0 --> 20282
    line [18438, 18287, 18290, 18265, 18222]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643"]
    y-axis "bytes" 0 --> 4201489
    line [3819535, 3807947, 3807947, 3802529, 3802528]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643"]
    y-axis "bytes" 0 --> 4191900
    line [3810818, 3801309, 3801305, 3796002, 3796002]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee"]
    y-axis "ms" 0 --> 20280
    line [18436, 18270, 18278, 18267, 18242, 18254, 14947, 14588, 14818, 13807, 13825, 13971, 13962, 13654, 13664, 13678, 13670, 14406, 14991, 13053]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee"]
    y-axis "ms" 0 --> 248
    line [225, 210, 218, 207, 182, 163, 59, 132, 117, 160, 166, 155, 155, 151, 142, 139, 136, 169, 135, 153]
```
...
xychart-beta
    ...
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee"]
    y-axis "ms" 0 --> 20282
    line [18438, 18287, 18290, 18265, 18222, 18275, 14936, 14957, 13769, 13952, 13820, 13811, 13660, 13653, 14556, 13636, 14711, 13355, 13197, 14098]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee"]
    y-axis "ms" 0 --> 254
    line [227, 221, 230, 221, 159, 209, 61, 106, 121, 168, 141, 163, 156, 157, 149, 146, 164, 152, 124, 156]
```
...
xychart-beta
    ...
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee"]
    y-axis "bytes" 0 --> 4201489
    line [3819535, 3807947, 3807947, 3802529, 3802528, 3802527, 3796378, 3791714, 3791716, 3770636, 3770634, 3771343, 3770634, 3767812, 3557908, 3544463, 3543472, 3523541, 3511474, 3496393]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["02d5be4", "3429b26", "cb374b6", "31e56b8", "398a643", "6f14815", "ba1b8bc", "3a63ea4", "d4d43f1", "8acf510", "df81309", "768e756", "9c3776c", "d6020c2", "69c3b49", "d08fbb7", "6412336", "5761c76", "7f4603c", "5cf02ee"]
    y-axis "bytes" 0 --> 4191900
    line [3810818, 3801309, 3801305, 3796002, 3796002, 3796005, 3788525, 3783517, 3783520, 3762734, 3762736, 3762498, 3762733, 3759872, 3548602, 3534279, 3535273, 3515861, 3502937, 3488256]
```
