...
Generated at **2026-06-18T13:15:05.750Z**.
...
xychart-beta
    ...
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68"]
    y-axis "ms" 0 --> 15905
    line [13245, 12382, 12632, 12566, 12399, 12420, 14457, 14459, 13617, 14386]
```
```mermaid
xychart-beta
    ...
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68"]
    y-axis "ms" 0 --> 178
    line [118, 138, 118, 75, 60, 110, 161, 142, 88, 135]
```
...
xychart-beta
    ...
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68"]
    y-axis "ms" 0 --> 16051
    line [12444, 11529, 12751, 11500, 12552, 12421, 13612, 14591, 14540, 13488]
```
```mermaid
xychart-beta
    ...
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68"]
    y-axis "ms" 0 --> 174
    line [126, 112, 141, 62, 68, 106, 158, 145, 107, 135]
```
...
xychart-beta
    ...
    line [3300034, 3300038, 3300630, 3300522, 3299950, 3296025, 3296632, 3296023, 3295973, 3295761]
```
```mermaid
xychart-beta
    ...
    line [3293198, 3293200, 3293409, 3293314, 3291396, 3288856, 3288399, 3288861, 3288877, 3288270]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d"]
    y-axis "ms" 0 --> 14570
    line [13245, 12382, 12632, 12566, 12399]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d"]
    y-axis "ms" 0 --> 14027
    line [12444, 11529, 12751, 11500, 12552]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
...
xychart-beta
    ...
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d"]
    y-axis "bytes" 0 --> 3630694
    line [3300034, 3300038, 3300630, 3300522, 3299950]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d"]
    y-axis "bytes" 0 --> 3622750
    line [3293198, 3293200, 3293409, 3293314, 3291396]
```
...
xychart-beta
    title "Web / PWA — LCP (ms)"
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228"]
    y-axis "ms" 0 --> 15905
    line [13245, 12382, 12632, 12566, 12399, 12420, 14457, 14459, 13617, 14386, 14419, 13497, 13828, 13339, 14256, 13811, 13665, 12311, 13514, 14099]
```
```mermaid
xychart-beta
    title "Web / PWA — TBT (ms)"
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228"]
    y-axis "ms" 0 --> 178
    line [118, 138, 118, 75, 60, 110, 161, 142, 88, 135, 159, 160, 153, 131, 151, 54, 71, 67, 59, 158]
```
...
xychart-beta
    ...
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228"]
    y-axis "ms" 0 --> 16051
    line [12444, 11529, 12751, 11500, 12552, 12421, 13612, 14591, 14540, 13488, 14410, 14392, 14255, 14254, 13354, 12763, 13959, 12313, 13510, 14082]
```
```mermaid
xychart-beta
    title "GitHub Pages — TBT (ms)"
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228"]
    y-axis "ms" 0 --> 182
    line [126, 112, 141, 62, 68, 106, 158, 145, 107, 135, 165, 137, 129, 155, 154, 63, 73, 57, 55, 125]
```
...
xychart-beta
    ...
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228"]
    y-axis "bytes" 0 --> 3630694
    line [3300034, 3300038, 3300630, 3300522, 3299950, 3296025, 3296632, 3296023, 3295973, 3295761, 3295758, 3295757, 3291461, 3291455, 3291464, 3287427, 3287424, 3287423, 3287424, 3287869]
```
```mermaid
xychart-beta
    title "Expo — iOS Hermes gzip total (bytes)"
    x-axis ["e9f962a", "03bb856", "aabc381", "ec2f02d", "7d43c9d", "b350fd1", "f4bee70", "189ea7f", "4cdf078", "2056f68", "d0fb0f7", "a53523f", "95287e7", "a01e98f", "eb58226", "21cf681", "b25a874", "52c24ba", "af742cc", "8c88228"]
    y-axis "bytes" 0 --> 3622750
    line [3293198, 3293200, 3293409, 3293314, 3291396, 3288856, 3288399, 3288861, 3288877, 3288270, 3288272, 3288270, 3283767, 3283770, 3283769, 3278198, 3278199, 3278191, 3278197, 3277689]
```
