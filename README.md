...
**Latest changes:** **[CHANGELOG.md](docs/CHANGELOG.md)** (current **v1.87.0** — locale tab refresh, model clear/redownload, pl-PL i18n; **v1.84.0–v1.86.0** benchmarks + LLM cache; **v1.78.0–v1.83.0** benchmark toolkit and AI engine CI).
...
[![CI builds](https://img.shields.io/badge/build-RN%20226%20%7C%20RN%20iOS%20226%20%7C%20Server%20275%20%7C%20Web%20279-2e7d32?style=flat-square)](https://github.com/Metaheurist/Rianell/actions/runs/27499345129)
...
| ![Beta](https://img.shields.io/badge/Beta-orange?style=flat-square&logoColor=white) **Web / PWA** (GitHub Pages deploy) | **279** |

Latest: [`App build/RNCLI-Android/app-debug-beta.apk`](App%20build/RNCLI-Android/latest.json) · [`App build/iOS/Health-Tracker-ios-alpha-build-226.zip`](App%20build/iOS/latest.json) · [`App build/Server/rianell-server-x64.exe`](App%20build/Server/latest.json) · [`App build/Server/rianell-server-x64.exe`](App%20build/Server/latest-x64.json) · [`App build/Server/rianell-server-x86.exe`](App%20build/Server/latest-x86.json) · [Workflow #279](https://github.com/Metaheurist/Rianell/actions/runs/27499345129) · `eeed001`
