...
**Latest changes:** **[CHANGELOG.md](docs/CHANGELOG.md)** (current **v1.83.0** — README doc icons + changelog-only release pointers; **v1.78.0–v1.82.0** benchmark toolkit and AI engine CI).
