...
**Latest changes:** **[CHANGELOG.md](docs/CHANGELOG.md)** (current **v1.77.0** — LC-20 i18n gap close-out, segmented **v1.71.0–v1.77.0**; prior **v1.70.0–v1.70.3** PWA fixes; **v1.54.0–v1.69.1** localization).
