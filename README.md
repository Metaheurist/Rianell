...
[![CI builds](https://img.shields.io/badge/build-Server%20748%20%7C%20Web%20748-2e7d32?style=flat-square)](https://github.com/Metaheurist/Rianell/actions/runs/30494133066)

**CI builds** (server + web)

| Channel | Build |
| :--- | :---: |
| ![CI](https://img.shields.io/badge/CI-2e7d32?style=flat-square&logoColor=white) **Server** EXE (x64) | **748** |
| ![CI](https://img.shields.io/badge/CI-2e7d32?style=flat-square&logoColor=white) **Server** EXE (x86) | **748** |
| ![CI](https://img.shields.io/badge/CI-2e7d32?style=flat-square&logoColor=white) **Web / PWA** (GitHub Pages deploy) | **748** |

Latest: [`artifacts/Server/rianell-server-x64.exe`](artifacts/Server/latest.json) · [`artifacts/Server/rianell-server-x64.exe`](artifacts/Server/latest-x64.json) · [`artifacts/Server/rianell-server-x86.exe`](artifacts/Server/latest-x86.json) · [Workflow #748](https://github.com/Metaheurist/Rianell/actions/runs/30494133066) · `28f8997`
