...
**Latest changes:** **[CHANGELOG.md](docs/CHANGELOG.md)** (current **v1.70.3** — PWA settings freeze, log expand, LLM model host, share button UI; **v1.54.0–v1.69.1** localization).
