...
[![CI builds](https://img.shields.io/badge/build-RN%20%E2%80%94%20%7C%20RN%20iOS%20%E2%80%94%20%7C%20Server%20106%20%7C%20Web%20206-2e7d32?style=flat-square)](https://github.com/Metaheurist/Rianell/actions/runs/23706232158)
...
Latest: [`App build/RNCLI-Android/latest.json`](App%20build/RNCLI-Android/latest.json) · [`App build/iOS/latest.json`](App%20build/iOS/latest.json) · [`App build/Server/rianell-server-x64.exe`](App%20build/Server/latest.json) · [`App build/Server/rianell-server-x64.exe`](App%20build/Server/latest-x64.json) · [`App build/Server/rianell-server-x86.exe`](App%20build/Server/latest-x86.json) · legacy Capacitor Android [`App build/Android/app-debug-beta-96.apk`](App%20build/Android/latest.json) · legacy Capacitor iOS [`App build/Legacy/Capacitor-iOS/Health-Tracker-ios-alpha-build-96.zip`](App%20build/Legacy/Capacitor-iOS/latest.json) · [Workflow #206](https://github.com/Metaheurist/Rianell/actions/runs/23706232158) · `2a95689`
